...
class IpfsClient(
    ...
    private val blockCache: Indexed<Join<CID, IpfsBlock>> = 0 j { 
    ...
    private fun addToCache(cid: CID, block: IpfsBlock) {
    ...
    private fun parseCID(hash: String): CID {
...
class IpfsStorage {
    ...
    private val pinnedBlocks = mutableSetOf<CID>()
