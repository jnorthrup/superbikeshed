...
object NarsBlackboardLattice {
    ...
    class Blackboard {
        private val beliefs = mutableMapOf<Statement, TruthValue>()
        private val goals = mutableMapOf<Statement, TruthValue>()
        private val questions = mutableSetOf<Statement>()
        private val temporal = mutableListOf<Task>()
        ...
        private fun propagateInheritance(statement: Statement, truth: TruthValue) {
        ...
        private fun derivePlans(goal: Statement) {
        ...
        private fun unify(pattern: Statement, statement: Statement): Boolean {
        ...
        private fun extractBindings(pattern: Statement, solution: Statement): List<Join<Term.Variable, Term>> {
