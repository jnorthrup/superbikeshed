...
internal class RequestFactoryServiceImpl(
     ...
     */
    internal fun getServiceInstance(serviceName: String): Any? {
     ...
     */
    internal suspend fun processServiceCall(service: Any, data: Indexed<Byte>): Indexed<Byte> {
        return when (service) {
     ...
     */
    internal fun createErrorResponse(code: Int, message: String): String {
