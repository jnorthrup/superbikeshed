...
class KrakenSkimmerStrategy(
    private val harvestTriggerPercent: Double = 3.0,
    private val rebalanceTriggerPercent: Double = 4.0,
    private val adaptiveHarvestPercent: Double = 2.0,
    private val adaptiveRebalancePercent: Double = 2.0,
    private val confirmationCycles: Int = 3,
    private val adaptiveConfirmationCycles: Int = 4,
    private val adaptiveTimeoutHours: Int = 3
) {
    
    private val baselineTrackers = mutableMapOf<Symbol, BaselineTracker>()
    ...
    private fun getOrCreateTracker(symbol: Symbol, candles: CandleSeries): BaselineTracker {
    ...
    private fun updateAdaptiveMode(tracker: BaselineTracker, currentTime: Instant) {
    ...
    private fun generateSkimmerSignal(
        currentPrice: Price,
    ...
    private fun calculateRecentVolatility(candles: CandleSeries): Double {
    ...
    private fun determineMarketRegime(volatility: Double, deviation: DeviationPercent): MarketRegime {
        return when {
...
class PortfolioSkimmer(
    private val skimmerStrategy: KrakenSkimmerStrategy = KrakenSkimmerStrategy(),
    private val crashProtectionThreshold: Double = 70.0, // % of assets declining
...
class AttentionKrakenSkimmer(
    private val portfolioSkimmer: PortfolioSkimmer = PortfolioSkimmer(),
