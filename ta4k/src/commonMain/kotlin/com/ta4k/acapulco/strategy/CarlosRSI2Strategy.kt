...
class CarlosRSI2Strategy(
    ...
    internal val rsiOversoldThreshold: Double = 5.0,
    internal val rsiOverboughtThreshold: Double = 95.0
) {
    ...
    internal fun calculateRSI(prices: Indexed<Price>, period: Int): RSISeries {
    ...
    internal fun calculateSMA(prices: Indexed<Price>, period: Int): SMASeries {
    ...
    internal fun isCarlosBuySignal(
        price: Price,
        rsi: RSIValue,
        shortSma: SMAValue,
        longSma: SMAValue
    ...
    internal fun isCarlosSellSignal(
        price: Price,
        rsi: RSIValue,
        shortSma: SMAValue,
        longSma: SMAValue
    ...
    internal fun analyzeTrend(shortSMA: SMASeries, longSMA: SMASeries): TrendAnalysis {
...
class AttentionCarlosRSI2(
    internal val strategy: CarlosRSI2Strategy = CarlosRSI2Strategy(),
