...
class StrategyOrchestrator(
    private val historicalDataManager: HistoricalDataManager,
    private val attentionTracker: HistoricalAttentionTracker,
    private val carlosStrategy: AttentionCarlosRSI2,
    private val krakenSkimmer: AttentionKrakenSkimmer
) {
    ...
    private fun createStrategyVotes(
    ...
    private fun convertSkimmerSignal(skimmerAction: SkimmerAction): TradeSignal {
    ...
    private fun calculateCarlosConfidence(analysis: StrategyAnalysis): StrategyConfidence {
    ...
    private fun calculateSkimmerConfidence(analysis: SkimmerAnalysis): StrategyConfidence {
