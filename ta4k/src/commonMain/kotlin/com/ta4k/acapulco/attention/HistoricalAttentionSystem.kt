...
class HistoricalAttentionAnalyzer {
    ...
    internal fun calculateVolumeScores(candles: CandleSeries): Indexed<VolumeGauge> {
    ...
    internal fun combineGauges(volatilityScores: Indexed<VolatilityGauge>, volumeScores: Indexed<VolumeGauge>): Indexed<AttentionScore> {
    ...
    internal fun findAttentionWindows(attentionScores: Indexed<AttentionScore>): AttentionSeries {
...
class HistoricalAttentionTracker(
    internal val dataManager: HistoricalDataManager,
    internal val analyzer: HistoricalAttentionAnalyzer = HistoricalAttentionAnalyzer()
) {
