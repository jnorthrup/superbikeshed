...
class ResponsiveCursorSlab(
    internal val hotWindowSize: Int = 10_000,
    internal val maxSize: Int = 100_000
) {
    internal var activeData: Indexed<TimestampedCandle> = Indexed.of(0) { error("Empty slab") }
...
class ParallelCSVProcessor {
    ...
    internal fun parseKlineLine(line: String): TimestampedCandle {
...
class HistoricalDataManager {
    internal val cursorSlabs = mutableMapOf<Symbol, ResponsiveCursorSlab>()
    internal val csvProcessor = ParallelCSVProcessor()
...
class BinanceDataVisionConnector(
    internal val dataManager: HistoricalDataManager = HistoricalDataManager()
) {
