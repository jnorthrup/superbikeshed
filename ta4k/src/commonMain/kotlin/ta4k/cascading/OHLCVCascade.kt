...
object OHLCVCascade {
    ...
    private fun Cursor.sma(period: Int, column: String): Indexed<Double?> {
    ...
    private fun Cursor.rsi(period: Int): Indexed<Double?> {
    ...
    private fun Cursor.addColumns(vararg columns: Pair<String, Indexed<*>>): Cursor {
