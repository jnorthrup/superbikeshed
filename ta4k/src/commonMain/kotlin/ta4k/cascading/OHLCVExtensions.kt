...
private fun Indexed<Double?>.ema(period: Int): Indexed<Double?> {
...
private fun Cursor.ema(period: Int, columnIndex: Int): Indexed<Double?> {
...
private fun calculateCorrelation(cursor1: Cursor, cursor2: Cursor): Double {
...
private fun Cursor.updateLastBar(tick: Tick): Cursor {
...
private fun Cursor.appendNewBar(tick: Tick): Cursor {
