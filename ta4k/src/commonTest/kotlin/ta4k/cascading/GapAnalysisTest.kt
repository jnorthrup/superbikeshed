...
class GapAnalysisTest {
    ...
    private fun generateTrendingOHLCV(bars: Int): Cursor {
    ...
    private fun generateTestTicks(count: Int): List<Tick> {
...
data class CorrelationMatrix(private val matrix: Map<Pair<String, String>, Double>) {
