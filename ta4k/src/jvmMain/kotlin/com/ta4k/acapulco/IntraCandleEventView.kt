...
class IntraCandleEventView(
    internal val muxer: TradePairEventMuxer, // Requires ITradePairEventMuxer interface from Acapulco
    internal val streamer: Streamer, // Requires Streamer class from Acapulco
