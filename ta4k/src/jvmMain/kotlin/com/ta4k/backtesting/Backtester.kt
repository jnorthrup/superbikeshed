...
class Backtester(
    ...
    @Suppress("UNUSED_PARAMETER") internal val initialCapital: BigDecimal = BigDecimal("100000"), // Illustrative, marked unused
    internal val defaultOrderAmount: BigDecimal = BigDecimal("1")    // e.g., 1 unit of base asset
) {
    /**
