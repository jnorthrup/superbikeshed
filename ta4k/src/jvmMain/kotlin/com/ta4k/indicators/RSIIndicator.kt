 ...
 */
class RSIIndicator(
    internal val klineSeries: Indexed<Kline>,
    ...
    // Internal caches
    internal val results = mutableListOf<BigDecimal?>()
    internal val avgGains = mutableListOf<BigDecimal?>()
    internal val avgLosses = mutableListOf<BigDecimal?>()
    internal var calculatedUpToIndex = -1

    internal val calculationScale = 8
    internal val resultScale = 2

    internal fun ensureListSize(list: MutableList<BigDecimal?>, requiredSize: Int) {
    ...
    internal fun calculateRSI(avgGain: BigDecimal, avgLoss: BigDecimal): BigDecimal {
