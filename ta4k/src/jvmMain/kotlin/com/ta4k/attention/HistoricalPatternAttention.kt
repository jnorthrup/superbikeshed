...
class HistoricalPatternAttention(
    internal val windowSize: Int = 100,  // Number of candles to analyze at once
    internal val minConfidence: Double = 0.7  // Minimum confidence threshold for patterns
) {
    // Pattern categories
    ...
    // Internal state
    internal val patterns = mutableListOf<Pattern>()
    internal var lastAnalysisIndex = -1
     ...
     */
    internal fun analyzePricePatterns(window: Indexed<Kline>, startIndex: Int): List<Pattern> {
     ...
     */
    internal fun analyzeVolumePatterns(window: Indexed<Kline>, startIndex: Int): List<Pattern> {
        val patterns = mutableListOf<Pattern>()
     ...
     */
    internal fun analyzeIndicatorPatterns(window: Indexed<Kline>, startIndex: Int): List<Pattern> {
        val patterns = mutableListOf<Pattern>()
     ...
     */
    internal fun analyzeCombinedPatterns(window: Indexed<Kline>, startIndex: Int): List<Pattern> {
        val patterns = mutableListOf<Pattern>()
     ...
     * Calculate volume moving average
     */
    internal fun calculateVolumeMA(window: Indexed<Kline>): Indexed<Double> {
        val period = 20
     ...
     */
    internal fun calculateRSI(window: Indexed<Kline>): Indexed<Double> {
        val period = 14
