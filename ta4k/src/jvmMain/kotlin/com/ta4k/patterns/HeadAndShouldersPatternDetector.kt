...
object HeadAndShouldersPatternDetector {
    ...
    internal const val DEFAULT_SHOULDER_HEAD_RATIO_MIN = 0.50
    internal const val DEFAULT_SHOULDER_HEAD_RATIO_MAX = 0.98
    internal const val DEFAULT_NECKLINE_SYMMETRY_TOLERANCE = 0.10
    // internal const val DEFAULT_BREAKOUT_CONFIRMATION_PERCENT = 0.01 // Not used yet
    internal const val DEFAULT_MIN_PATTERN_DURATION = 10
    internal const val DEFAULT_MAX_PATTERN_DURATION = 150
