...
class BollingerBandsIndicatorTest {
    ...
    internal fun kline(close: String, scale: Int = 2) = Kline( // Allow specifying scale for price
    ...
    internal val defaultResultScale = 2 // Default scale for assertions if not derived from kline data
