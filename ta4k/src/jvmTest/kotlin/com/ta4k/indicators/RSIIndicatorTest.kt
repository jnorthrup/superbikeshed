...
class RSIIndicatorTest {
    ...
    internal fun kline(close: String) = Kline(0L, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal(close), BigDecimal.ZERO, 0L, BigDecimal.ZERO, 0, BigDecimal.ZERO, BigDecimal.ZERO)
