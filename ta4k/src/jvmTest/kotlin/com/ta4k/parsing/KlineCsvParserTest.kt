...
class KlineCsvParserTest {
    ...
    private val validHeader = "Open_time,Open,High,Low,Close,Volume,Close_time,Quote_asset_volume,Number_of_trades,Taker_buy_base_asset_volume,Taker_buy_quote_asset_volume,Ignore"
    private val validDataLine1 = "1609459200000,100.0,110.0,90.0,105.0,1000.0,1609459259999,100500.0,50,600.0,60300.0,0"
    private val validDataLine2 = "1609459260000,105.0,115.0,95.0,110.0,1200.0,1609459319999,126000.0,60,700.0,73500.0,0"
