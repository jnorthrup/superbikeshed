...
class HeadAndShouldersPatternDetectorTest {
    ...
    internal fun kline(uniqueIdx: Int, high: String, low: String, close: String = low): Kline {
    ...
    internal fun sp(klineIdx: Int, priceStr: String, type: SwingType, highStr: String = priceStr, lowStr: String = priceStr): SwingPoint {
