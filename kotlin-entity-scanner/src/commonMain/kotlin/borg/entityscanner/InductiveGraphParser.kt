...
object PredicateSystem {
    ...
    private fun createState(id: String, position: ParsePosition, confidence: Double): ParseState {
...
object InductiveGraphParser {
    ...
    private fun analyzeContextForEvidence(
        sourceText: String, 
        position: ParsePosition,
    ...
    private fun calculateEvidenceStrength(
...
object LearningParser {
    ...
    fun parseWithRefinement(source: String): Join<GraphNodeSeries, RefinementSeries> {
        ...
        return graphNodes j refinements.toIndexed()
    }
    
    private fun createContextualPredicates(
        source: String, 
        position: ParsePosition
    ): PredicateSeries {
        ...
        return predicates.toIndexed()
    }
}

// ==== UTILITY EXTENSIONS ====

fun <T> List<T>.toIndexed(): Indexed<T> = size j { index -> this[index] }
