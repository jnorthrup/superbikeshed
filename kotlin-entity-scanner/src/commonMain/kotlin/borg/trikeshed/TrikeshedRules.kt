...
object TrikeshedForwardRules {
    internal val forwardChains = mutableListOf<() -> ForwardRuleSeries>()
...
object TrikeshedBackwardRules {
    internal val backwardChains = mutableListOf<() -> BackwardRuleSeries>()
...
internal fun markEntity(context: ParseContext, pos: Int, entity: UByte): ParseContext = context
internal fun validateTrikeshedUsage(context: ParseContext, pos: Int): ParseContext = context 