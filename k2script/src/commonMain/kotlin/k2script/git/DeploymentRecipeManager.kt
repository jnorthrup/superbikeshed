...
class DeploymentRecipeManager {
     ...
     */
    suspend fun generateRecipes(repoDir: String, featureName: String): List<DeploymentRecipe> {
     ...
     */
    internal fun detectProjectType(repoDir: String): ProjectType {
        return when {
            fileExists("$repoDir/build.gradle.kts") || fileExists("$repoDir/build.gradle") -> ProjectType.KOTLIN_JVM
            fileExists("$repoDir/package.json") -> ProjectType.NODE_JS
            fileExists("$repoDir/requirements.txt") || fileExists("$repoDir/pyproject.toml") -> ProjectType.PYTHON
            fileExists("$repoDir/go.mod") -> ProjectType.GO
            fileExists("$repoDir/pom.xml") -> ProjectType.JAVA
     ...
     */
    internal fun generateDockerRecipe(repoDir: String, featureName: String, projectType: ProjectType): DeploymentRecipe {
     ...
     */
    internal fun generateKubernetesRecipe(repoDir: String, featureName: String, projectType: ProjectType): DeploymentRecipe {
     ...
     */
    internal fun generateDockerComposeRecipe(repoDir: String, featureName: String, projectType: ProjectType): DeploymentRecipe {
     ...
     */
    internal fun generateHelmRecipe(repoDir: String, featureName: String, projectType: ProjectType): DeploymentRecipe {
     ...
     */
    internal fun generateTerraformRecipe(repoDir: String, featureName: String, projectType: ProjectType): DeploymentRecipe {
    ...
    internal fun generateKotlinDockerfile(repoDir: String, featureName: String): String {
        return """
    ...
    internal fun generateNodeDockerfile(repoDir: String, featureName: String): String {
        return """
    ...
    internal fun generatePythonDockerfile(repoDir: String, featureName: String): String {
        return """
    ...
    internal fun generateGoDockerfile(repoDir: String, featureName: String): String {
        return """
    ...
    internal fun generateJavaDockerfile(repoDir: String, featureName: String): String {
        return """
    ...
    internal fun generateGenericDockerfile(repoDir: String, featureName: String): String {
        return """
    ...
    internal fun generateK8sManifest(repoDir: String, featureName: String, projectType: ProjectType): String {
        val appName = repoDir.substringAfterLast('/').lowercase().replace(Regex("[^a-z0-9-]"), "-")
    ...
    internal fun generateDockerCompose(repoDir: String, featureName: String, projectType: ProjectType): String {
        val appName = repoDir.substringAfterLast('/').lowercase().replace(Regex("[^a-z0-9-]"), "-")
    ...
    internal fun generateHelmChart(repoDir: String, featureName: String, projectType: ProjectType): String {
        val appName = repoDir.substringAfterLast('/').lowercase().replace(Regex("[^a-z0-9-]"), "-")
    ...
    internal fun generateTerraformConfig(repoDir: String, featureName: String, projectType: ProjectType): String {
        val appName = repoDir.substringAfterLast('/').lowercase().replace(Regex("[^a-z0-9-]"), "-")
    ...
    internal fun generateGenericDockerRecipe(repoDir: String, featureName: String): DeploymentRecipe {
        return DeploymentRecipe(
            name = "Dockerfile",
            type = RecipeType.DOCKER,
