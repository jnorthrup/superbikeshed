...
class TrikeShedTaxonomy {
     ...
     */
    internal fun extractSemanticTags(featureName: String): List<String> {
     ...
     */
    internal fun estimateComplexity(featureName: String): ComplexityLevel {
        val lowerName = featureName.lowercase()
