...
class MagicCarpetMavenVFS(
    ...
    private val materializedCoordinates = ConcurrentHashMap<String, Boolean>()
     ...
     */
    private suspend fun materializeArtifact(groupId: String, artifactId: String, version: String) {
     ...
     */
    private fun findPomUrl(groupId: String, artifactId: String, version: String): String {
        val groupPath = groupId.replace(".", "/")
     ...
     */
    private fun findJarUrl(groupId: String, artifactId: String, version: String): String {
        val groupPath = groupId.replace(".", "/")
     ...
     */
    private fun findSha1Url(groupId: String, artifactId: String, version: String): String {
        val groupPath = groupId.replace(".", "/")
     ...
     */
    private fun getLocalPath(coordinate: String): Path {
        val (groupId, artifactId, version) = parseCoordinate(coordinate)
        val groupPath = groupId.replace(".", "/")
...
object MagicCarpetMaven {
    ...
    private val vfs = MagicCarpetMavenVFS()
