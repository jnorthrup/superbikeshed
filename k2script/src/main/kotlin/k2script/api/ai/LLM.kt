...
package k2script.api.ai

import k2script.ai.llm.LiteLLMClient
import k2script.ai.llm.LLMResponse // Make LLMResponse part of public API
 ...
 *
 * This function provides access to the underlying LiteLLM service managed by k2script.
 ...
 * import k2script.api.ai.stopLiteLLMService // Optional: to explicitly stop the service
 *
 * try {
 *   val response = askLLM(
 ...
 *   // stopLiteLLMService()
 *   // Otherwise, it will be stopped when the k2script process ends (or JVM exits).
 * }
 * ```
 */
 ...
 *
 * Normally, the service is managed automatically and should shut down when the main k2script
