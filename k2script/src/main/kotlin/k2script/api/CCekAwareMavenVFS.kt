...
class CCekAwareMavenVFS(
    ...
    internal val contextCache = ConcurrentHashMap<String, ConcurrentHashMap<String, Boolean>>()
     ...
     */
    internal fun resolveContextualVersion(version: String, context: ExecutionContext): String {
        return when {
     ...
     */
    internal fun resolveLatestCompatibleVersion(versionRange: String, context: ExecutionContext): String {
     ...
     */
    internal fun resolveLatestVersion(context: ExecutionContext): String {
     ...
     */
    internal suspend fun materializeContextualArtifact(
        groupId: String, 
        artifactId: String, 
        version: String, 
        context: ExecutionContext
     ...
     */
    internal fun getContextualArtifactDir(
        groupId: String, 
        artifactId: String, 
        version: String, 
        context: ExecutionContext
     ...
     */
    internal fun filterRepositoriesBySecurity(context: ExecutionContext): List<String> {
     ...
     */
    internal fun findContextualPomUrl(
        groupId: String, 
        artifactId: String, 
        version: String, 
     ...
     */
    internal fun findContextualJarUrl(
        groupId: String, 
        artifactId: String, 
        version: String, 
        repositories: List<String>
     ...
     */
    internal fun findContextualSha1Url(
        groupId: String, 
        artifactId: String, 
        version: String, 
        repositories: List<String>
     ...
     */
    internal fun getContextualPath(coordinate: String, context: ExecutionContext): Path {
        val (groupId, artifactId, version) = parseCoordinate(coordinate)
        val groupPath = groupId.replace(".", "/")
        val contextSuffix = if (context.sandboxMode) "-sandbox" else ""
        return localRepository.resolve("contextual$contextSuffix")
...
object CCekMaven {
    ...
    internal val vfs = CCekAwareMavenVFS()
