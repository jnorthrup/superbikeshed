...
object MCPCommand {
    ...
    internal val gateway = MCPGateway()
    internal val hostingService = MCPHostingService()
    internal val lifecycleManager = MCPServerLifecycleManager()
    internal val healthChecker = MCPHealthChecker()
    internal val scalingManager = MCPScalingManager()
    ...
    internal suspend fun handleStart(args: Array<String>) {
        if (args.isEmpty()) {
    ...
    internal suspend fun handleStop(args: Array<String>) {
        if (args.isEmpty()) {
            println("Error: Server name required")
            return
        }
    ...
    internal suspend fun handleDeploy(args: Array<String>) {
        if (args.isEmpty()) {
    ...
    internal suspend fun handleHealth() {
        val servers = registry.discover()
    ...
    internal suspend fun handleScale(args: Array<String>) {
    ...
    internal fun handleRegister(args: Array<String>) {
        if (args.size < 3) {
    ...
    internal suspend fun handleRoute(args: Array<String>) {
        if (args.size < 2) {
