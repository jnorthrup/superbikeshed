...
object GitFeatureCommand {
    ...
    internal val gitManager = GitFeatureBranchManager()
    ...
    internal suspend fun handleCreate(args: Array<String>) {
        if (args.isEmpty()) {
    ...
    internal suspend fun handleClone(args: Array<String>) {
        if (args.size < 2) {
    ...
    internal suspend fun handleStatus(args: Array<String>) {
        if (args.isEmpty()) {
            println("Error: Feature name required")
            return
        }
    ...
    internal suspend fun handlePush(args: Array<String>) {
        if (args.isEmpty()) {
            println("Error: Feature name required")
            return
        }
    ...
    internal suspend fun handleDelete(args: Array<String>) {
        if (args.isEmpty()) {
            println("Error: Feature name required")
            return
        }
    ...
    internal suspend fun handleRecipes(args: Array<String>) {
        if (args.isEmpty()) {
            println("Error: Feature name required")
            return
        }
    ...
    internal fun handleTaxonomy(args: Array<String>) {
        if (args.isEmpty()) {
            println("Error: Feature name required")
            return
        }
    ...
    internal suspend fun handleLFS(args: Array<String>) {
        if (args.isEmpty()) {
