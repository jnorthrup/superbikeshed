...
class ChannelTransport(
    ...
    internal suspend fun ProducerScope<ByteIndexed>.fetchHttpStream(url: String) {
    ...
    internal suspend fun ProducerScope<ByteIndexed>.fetchQuicStream(url: String) {
    ...
    internal suspend fun ProducerScope<ByteIndexed>.fetchFileStream(url: String) {
...
class ChannelRepositoryCache(
    ...
    internal val metadataChannel = Channel<RepositoryMetadata>(Channel.UNLIMITED)
...
class ChannelTrikeShedWagon(
    ...
    internal val cache: ChannelRepositoryCache = ChannelRepositoryCache(),
