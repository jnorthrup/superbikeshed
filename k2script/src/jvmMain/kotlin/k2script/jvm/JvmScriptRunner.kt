...
class JvmScriptRunner(
    private val kotlinHome: String = System.getenv("KOTLIN_HOME") ?: findKotlinHome(),
    private val javaHome: String = System.getProperty("java.home")
) {
    
    private val kotlinc = "$kotlinHome/bin/kotlinc"
    private val kotlin = "$kotlinHome/bin/kotlin"
    ...
    private fun buildJarRunCommand(
        jarFile: File,
        mainClass: String,
        args: Array<String>,
        classpath: List<String>,
    ...
    companion object {
        private fun findKotlinHome(): String {
