...
class LoggerTest {
    internal val exception1 = IllegalArgumentException("Test message\nSecond line")
    internal val exception2 = IllegalStateException("This is some sophisticated exception message.")
