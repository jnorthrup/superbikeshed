...
class FileUtilsTest {
    internal val path = OsPath.createOrThrow(OsType.native, "./build/tmp/file_utils_test")
    internal val newFile1 = path.resolve("test1.txt")
    internal val newFile2 = path.resolve("test2.txt")
    internal val newFile3 = path.resolve("firstDir", "secondDir", "test3.txt")
    internal val newFile4 = path.resolve("dir1", "dir2", "test4.txt")
    internal val content1 = "Test\nContent\n"
