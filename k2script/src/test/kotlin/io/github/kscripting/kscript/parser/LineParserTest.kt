...
import io.github.kscripting.kscript.parser.LineParser.parseDependency
import io.github.kscripting.kscript.parser.LineParser.parseEntry
...
class LineParserTest {
    ...
    companion object {
        @JvmStatic
        internal val scriptLocation = ScriptLocation(
        ...
        internal const val repositoryReleasesUrl = "http://maven.imagej.net/content/repositories/releases"
        internal const val repositorySnapshotsUrl = "http://maven.imagej.net/content/repositories/snapshots"
