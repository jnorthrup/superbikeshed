...
class CommandResolverTest {
    internal val compilerOpts = setOf(CompilerOpt("-abc"), CompilerOpt("-def"), CompilerOpt("--experimental"))
    internal val kotlinOpts = setOf(KotlinOpt("-k1"), KotlinOpt("-k2"), KotlinOpt("--disable"))
    internal val userArgs = listOf("arg", "u", "ments")
    ...
    internal fun createTestData(osType: OsType, homeDirString: String, kotlinDirString: String): TestData {
