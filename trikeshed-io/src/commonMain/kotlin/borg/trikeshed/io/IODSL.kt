 ...
 */
class IODSL(internal val daemon: IODaemon) {
...
class IOSession(
    internal val fd: Int,
    internal val daemon: IODaemon
) {
    internal var operationId = 0L
...
/*
class IOHandle(
    internal val type: IODaemonOperation.IODaemonOperationType,
    internal val daemon: IODaemon
) {
    internal var operationId = 0L
 ...
 */
class IOBatchBuilder(internal val daemon: IODaemon) {
    internal val operations = mutableListOf<IODaemonOperation>()
    internal var operationId = 0L
 ...
 */
class IOStreamBuilder(internal val daemon: IODaemon) {
    internal val operations = mutableListOf<IODaemonOperation>()
    internal var operationId = 0L
