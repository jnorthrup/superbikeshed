...
class CapBasedBacktester {
    ...
    internal val marketCapData = mapOf(
    ...
    internal fun generateEntryPrice(symbol: Symbol): Price {
...
internal fun Decimal.formatBillions(): String = (this / 1_000_000_000.0).format(1)
