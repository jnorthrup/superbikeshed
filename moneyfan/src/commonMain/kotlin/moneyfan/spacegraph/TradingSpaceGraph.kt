...
class TradingSpaceGraphRenderer {
    internal var lastVisualization: TradingVisualization? = null
    ...
    internal fun createCandleNodes(candleSeries: CandleSeries): List<TradingNode> {
        val nodes = mutableListOf<TradingNode>()
    ...
    internal fun createPortfolioNodes(portfolioState: PortfolioState): List<TradingNode> {
        val nodes = mutableListOf<TradingNode>()
    ...
    internal fun createIndicatorNodes(indicators: Map<String, PriceSeries>): List<TradingNode> {
        val nodes = mutableListOf<TradingNode>()
    ...
    internal fun createPriceMovementEdges(candleNodes: List<TradingNode>): List<TradingEdge> {
        val edges = mutableListOf<TradingEdge>()
    ...
    internal fun createPositionEdges(portfolioNodes: List<TradingNode>, candleNodes: List<TradingNode>): List<TradingEdge> {
        val edges = mutableListOf<TradingEdge>()
    ...
    internal fun createIndicatorEdges(indicatorNodes: List<TradingNode>, candleNodes: List<TradingNode>): List<TradingEdge> {
        val edges = mutableListOf<TradingEdge>()
