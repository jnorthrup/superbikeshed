...
class MDITraceLogger {
    internal val traceBuffer = mutableListOf<TraceEntry>()
    internal val maxTraceEntries = 1000
...
class MDIInterface {
    internal val windows = mutableMapOf<String, MDIWindow>()
    internal val tracer = MDITraceLogger()
    internal var activeWindowId: String? = null
    internal val spaceGraphNodeHandlers = mutableMapOf<SpaceGraphNode, () -> Unit>()
    internal val nodeActivationStates = mutableMapOf<SpaceGraphNode, Boolean>()
    ...
    internal fun setupSpaceGraphNodes() {
    ...
    internal fun createDefaultWindows() {
    ...
    internal fun getSpaceGraphNodeDescription(node: SpaceGraphNode): String = when (node) {
    ...
    internal fun openOrFocusWindow(id: String, title: String, content: WindowContent) {
    ...
    internal fun focusWindow(id: String) {
    ...
    internal fun getSpaceGraphNodeMappings(): Indexed<Join<SpaceGraphNode, String>> {
        val mappings = listOf(
