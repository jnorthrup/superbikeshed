...
class SimpleRqlParser {
    ...
    private val operatorMap: Map<String, RqlOperator> = mapOf(
    ...
    private val generalConditionPattern = run {
    ...
    private val betweenConditionPattern =
     ...
     */
    private fun parseSingleOrCompound(queryPart: String): RqlQueryNode? {
     ...
     */
    private fun parseAtomicCondition(queryPart: String): RqlSimpleQuery? {
        val trimmedQueryPart = queryPart.trim()
     ...
     */
    private fun parseValue(valueStr: String, operator: RqlOperator): Any? {
     ...
     */
    private fun parseNumericValue(valueStr: String): Number? {
        val cleanedValueStr = valueStr.removeQuotes().trim()
