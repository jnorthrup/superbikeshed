...
class BacktestRunner {
    ...
    internal val binanceProcessor = BinanceDataProcessor()
    internal val moneyfanBridge = MoneyfanBridge()
    
    // Proven trading patterns from coinbaseXChangeBot
    internal val carlosRSI2Strategy = CarlosRSI2Strategy()
    internal val krakenSkimmerStrategy = KrakenSkimmerStrategy()
    ...
    internal fun startMDIApplication(): MoneyFanMDIApplication {
    ...
    internal suspend fun loadHistoricalDataWithVisualization(
        symbols: List<String>,
        startDate: LocalDate,
        endDate: LocalDate
    ) {
    ...
    internal suspend fun executeBacktestStrategies(
        symbols: List<String>,
        startDate: LocalDate,
        endDate: LocalDate,
    ...
    internal suspend fun executeTradesForSymbol(
        symbol: String,
    ...
    internal suspend fun visualizeBacktestResults(results: BacktestResults) {
    ...
    internal suspend fun simulateRealTimeTrading(symbols: List<String>) {
    ...
    internal suspend fun updateMDIStatus(message: String) {
    ...
    internal fun generateSampleCandleData(symbol: String, startDate: LocalDate, endDate: LocalDate): CandleSeries {
    ...
    internal fun generateTicksFromCandles(candles: CandleSeries, symbol: String): TickSeries {
