...
class MoneyFanMDIApplication : JFrame("MoneyFan Trading System") {
    ...
    // Core components
    private val tradingDashboard = TradingDashboard()
    private val spaceGraphLoader = SpaceGraphMasterLoader()
    private val attentionTicker = AttentionBasedTicker()
    
    // Window management
    private val openWindows = mutableMapOf<String, JInternalFrame>()
    ...
    private fun createSpaceGraphControlPanel(): JPanel {
    ...
    private fun createSpaceGraphNode(label: String, color: Color, action: () -> Unit): JButton {
    ...
    private fun createTradingDashboardWindow() {
    ...
    private fun createSpaceGraphWindow() {
    ...
    private fun createAttentionTickerWindow() {
    ...
    private fun createAttentionTickerPanel(): JPanel {
    ...
    private fun createTechnicalAnalysisWindow() {
    ...
    private fun showOrFocusWindow(windowId: String) {
    ...
    private fun stopTradingBot() {
        // Stop trading operations
    }
    
    private fun startAttentionTicker() {
        scope.launch {
    ...
    private fun loadBinanceArchive() {
    ...
    private fun updateAttentionDisplay(attentionSeries: AttentionSeries) {
