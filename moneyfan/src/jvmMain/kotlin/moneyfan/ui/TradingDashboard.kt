...
class TradingDashboard : JPanel(BorderLayout()) {
    ...
    // UI Components
    internal val portfolioPanel = JPanel(BorderLayout())
    internal val tradingPanel = JPanel(BorderLayout()) 
    internal val marketPanel = JPanel(BorderLayout())
    internal val controlPanel = JPanel(FlowLayout())
    
    // Display components
    internal val portfolioTable = createPortfolioTable()
    internal val tradingStatusLabel = JLabel("Trading Status: Ready")
    internal val marketIndicatorsPanel = JPanel(GridLayout(2, 3))
    internal val chartPanel = JPanel(BorderLayout())
    ...
    internal fun createPortfolioTable(): JTable {
    ...
    internal fun createPortfolioSummary(): JPanel {
    ...
    internal fun createTradingControls(): JPanel {
    ...
    internal fun createMarketChart(): JPanel {
        return JPanel().apply {
            background = Color.BLACK
    ...
    internal fun startDataSubscriptions() {
    ...
    internal fun updateTradingDisplay(tradingState: AcapulcoTradingState) {
        SwingUtilities.invokeLater {
    ...
    internal fun updateMarketDisplay(marketState: MarketState) {
        SwingUtilities.invokeLater {
    ...
    internal fun createIndicatorLabel(name: String, value: String, color: Color): JPanel {
