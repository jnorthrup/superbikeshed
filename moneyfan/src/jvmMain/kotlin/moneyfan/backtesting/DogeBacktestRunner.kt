...
class DogeBacktestRunner {
    ...
    private val backtestPeriods = listOf(
        BacktestPeriod(
            name = "Pre-Pump 2020",
    ...
    private fun runPeriodBacktest(period: BacktestPeriod): BacktestResult {
    ...
    private fun loadHistoricalDogeData(period: BacktestPeriod): List<Kline> {
    ...
    private fun generateCarlosSignal(window: List<Kline>): String {
    ...
    private fun generateSkimmerSignal(window: List<Kline>, currentPrice: Double): String {
    ...
    private fun calculateBacktestAttention(window: List<Kline>): Double {
    ...
    private fun calculateWindowVolatility(window: List<Kline>): Double {
    ...
    private fun createBacktestAttentionSystem(): AttentionSystem {
