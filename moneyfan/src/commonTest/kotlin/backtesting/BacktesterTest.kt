 ...
 */
internal class MockTradingStrategy(internal val signalsToReturn: List<TradingSignal>) : TradingStrategyInterface {
    internal var signalIndex = 0
...
class BacktesterTest {
     ...
     */
    internal fun createMockKlineCursor(klineData: List<RowVec>): Cursor {
