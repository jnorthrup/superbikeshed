...
class BacktestEngine(
    internal val initialCapital: BigDecimal,
    internal val tradingFee: BigDecimal = BigDecimal("0.001") // 0.1% default fee
) {
    internal var currentCapital = initialCapital
    internal var currentPosition: Position? = null
    internal val tradeHistory = mutableListOf<TradeResult>()
    ...
    internal fun calculatePositionSize(price: BigDecimal): BigDecimal {
    ...
    internal fun calculatePnL(position: Position, exitPrice: BigDecimal): BigDecimal {
