...
object JmhBenchmark {
    ...
    internal fun runPropertyExtractionBenchmark() {
    ...
    internal fun runParsingBenchmark() {
    ...
    internal fun runBigJsonBenchmark() {
    ...
    internal inline fun measureTime(block: () -> Unit): Double {
