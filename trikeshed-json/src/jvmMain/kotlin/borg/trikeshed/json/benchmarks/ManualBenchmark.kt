...
class ManualBenchmark {
    ...
    internal fun benchmarkScanProperties() {
    ...
    internal fun benchmarkScanAndQuery() {
    ...
    internal fun benchmarkFingerprint() {
        val sizes = listOf(100, 1000, 10000)
        val iterations = 1000
    ...
    internal fun benchmarkLargeArray() {
        val sizes = listOf(100, 1000, 10000)
        val iterations = 100
    ...
    internal fun benchmarkRepeatedQueries() {
        val json = """{
            "user": {
                "name": "John Doe",
                "age": 30,
    ...
    internal inline fun benchmarkOperation(iterations: Int, operation: (Int) -> Unit): Double {
        // Warmup
    ...
    internal fun generateArrayJson(count: Int): String = buildString {
        append("[")
        repeat(count) { i ->
            if (i > 0) append(",")
