...
class KotlinBenchmark {
    ...
    private fun runBigJsonTest(bigJson: String) {
    ...
    private fun generateBigJson(count: Int): String = buildString {
        append("{\"data\":[")
        repeat(count) { i ->
            if (i > 0) append(",")
