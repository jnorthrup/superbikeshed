...
class VectorApiBenchmark {
    ...
    internal fun benchmarkStructuralScanning() {
    ...
    internal fun benchmarkStringExtraction() {
    ...
    internal fun benchmarkFullParsing() {
    ...
    internal fun benchmarkBatchOperations() {
    ...
    internal fun generateJson(size: Int): String {
    ...
    internal fun generateMixedJson(size: Int): String {
        return """
        {
            "metadata": {
                "version": "1.0",
