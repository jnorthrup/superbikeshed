...
class SwarmJsonScanner(
    ...
    internal val coreCount = NSProcessInfo.processInfo.processorCount.toInt()
     ...
     */
    internal fun processChunkWithNeon(data: ByteArray, start: Int, end: Int): IntArray {
    ...
    internal fun calculateThroughput(bytes: Int, nanos: Long): Double {
...
class CoroutineSwarmJsonScanner(
    ...
    companion object {
        internal val structuralBytes = byteArrayOf(
            '{'.code.toByte(), '}'.code.toByte(),
            '['.code.toByte(), ']'.code.toByte(),
            ':'.code.toByte(), ','.code.toByte(),
            '"'.code.toByte()
...
class SwarmBenchmark {
    ...
    internal fun generateLargeJson(size: Int): String {
