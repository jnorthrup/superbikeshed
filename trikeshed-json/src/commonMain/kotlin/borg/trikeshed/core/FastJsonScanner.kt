...
import borg.trikeshed.core.JsonProperty

/**
 * Fast JSON Scanner with LinkedHashMap for O(1) queries
 * Combines bitmap scanning with efficient property lookup
 */
class FastJsonScanner(internal val input: CharSequence) {
    
    internal val propertyMap = LinkedHashMap<String, String>()
    internal val properties = mutableListOf<JsonProperty>()
