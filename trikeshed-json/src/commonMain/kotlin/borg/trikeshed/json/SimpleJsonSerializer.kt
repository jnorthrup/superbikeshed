...
class SimpleTrikeShedJsonFormat(
    private val configuration: SimpleTrikeShedJsonConfiguration
) : StringFormat {
    ...
    private fun createSimpleDecoder(input: String): SimpleTrikeShedJsonDecoder {
...
class SimpleTrikeShedJsonDecoder(
    ...
    private val scanner: SimpleJsonScanner,
    private val document: SimpleJsonDocument,
