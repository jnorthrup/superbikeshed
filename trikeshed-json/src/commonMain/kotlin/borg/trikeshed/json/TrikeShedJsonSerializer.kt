...
class TrikeShedJsonFormat(
    private val configuration: TrikeShedJsonConfiguration
) : StringFormat {
    ...
    private fun createBitmapDecoder(input: String): TrikeShedJsonDecoder {
...
class TrikeShedJsonDecoder(
    ...
    private val scanner: JsonScannerCompact,
