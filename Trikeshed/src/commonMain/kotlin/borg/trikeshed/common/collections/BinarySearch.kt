...
fun Indexed<Short>.binarySearch(element: Short, low_: Int = 0, high_: Int = size - 1): Int {
    var low = low_
    var high = high_
...
fun Indexed<Int>.binarySearch(element: Int, low_: Int = 0, high_: Int = size - 1): Int {
    var low = low_
    var high = high_
...
fun Indexed<Long>.binarySearch(element: Long, low_: Int = 0, high_: Int = size - 1): Int {
    var low = low_
    var high = high_
...
fun Indexed<Float>.binarySearch(element: Float, low_: Int = 0, high_: Int = size - 1): Int {
    var low = low_
    var high = high_
...
fun Indexed<Double>.binarySearch(element: Double, low_: Int = 0, high_: Int = size - 1): Int {
    var low = low_
    var high = high_
...
fun Indexed<Char>.binarySearch(element: Char, low_: Int = 0, high_: Int = size - 1): Int {
    var low = low_
    var high = high_
...
//ubyte, then ...
fun Indexed<UByte>.binarySearch(element: UByte, low_: Int = 0, high_: Int = size - 1): Int {
    var low = low_
    var high = high_
...
fun Indexed<UShort>.binarySearch(element: UShort, low_: Int = 0, high_: Int = size - 1): Int {
    var low = low_
    var high = high_
...
fun Indexed<UInt>.binarySearch(element: UInt, low_: Int = 0, high_: Int = size - 1): Int {
    var low = low_
    var high = high_
 ...
 */
fun Indexed<ULong>.binarySearch(element: ULong, low_: Int = 0, high_: Int = size - 1): Int {
    var low = low_
    var high = high_
