...
object TrikeShedJsonScanner {
     ...
     */
    private fun tokenize(chars: Indexed<JsonChar>): JsonTokenSeries {
    ...
    private inline fun scanNextToken(chars: Indexed<JsonChar>, pos: JsonPosition): JsonToken {
     ...
     */
    private fun scanWhitespace(chars: Indexed<JsonChar>, start: JsonPosition): JsonToken {
        var pos = start
     ...
     */
    private fun scanString(chars: Indexed<JsonChar>, start: JsonPosition): JsonToken {
     ...
     */
    private fun scanNumber(chars: Indexed<JsonChar>, start: JsonPosition): JsonToken {
        var pos = start
