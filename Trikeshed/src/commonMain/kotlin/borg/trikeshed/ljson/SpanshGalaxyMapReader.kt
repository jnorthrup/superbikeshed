...
class SpanshGalaxyMapReader(
    ...
    private val blockCache: BlockCache = LRUBlockCache(maxSizeBytes = 1024 * 1024 * 1024) // 1GB cache
) {
     ...
     */
    private fun parseIndexMetadata(json: String): SpanshIndexMetadata {
     ...
     */
    private fun findRelevantBlocks(
        index: SpanshIndexMetadata,
        regions: List<GalacticRegion>
     ...
     */
    private suspend fun fetchAndDecompressBlock(
        fileId: String,
        index: SpanshIndexMetadata,
     ...
     */
    private fun parseSystemsFromBlock(
     ...
     */
    private suspend fun decompressWithSyncPoint(
     ...
     */
    private fun regionsIntersect(a: GalacticRegion, b: GalacticRegion): Boolean {
     ...
     */
    private fun systemInRegion(system: GalaxySystem, region: GalacticRegion): Boolean {
        val (x, yz) = system.coords
        val (y, z) = yz
     ...
     */
    private fun generateExpandingRegions(
        centerX: Double,
        centerY: Double,
        centerZ: Double,
        maxDistance: Double
