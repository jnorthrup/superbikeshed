...
sealed class IOContext {
    ...
    data class UringContext(
        ...
        private val capabilityArray: Array<IOCapability> = arrayOf(
...
class IOContextManager {
    private val contexts: MutableMap<ContextId, IOContext> = mutableMapOf()
    private val services: MutableMap<ServiceId, ServiceRegistration> = mutableMapOf()
    private val assignments: MutableMap<ServiceId, ContextId> = mutableMapOf()
     ...
     */
    private fun findCompatibleContext(required: CapabilitySet): IOContext {
     ...
     */
    private fun hasAllCapabilities(
     ...
     */
    private fun assignServiceToContext(serviceId: ServiceId, context: IOContext) {
