...
class Socks5ServerBuilder {
    private var bindAddress: String = "0.0.0.0"
    private var bindPort: Int = 1080
    private var ioContext: IOContext? = null
    private var scope: CoroutineScope? = null
    private var maxConnections: Int = 1000
 ...
 */
class Socks5Relay(
    private val clientChannel: Channel<ByteArray>,
    private val targetChannel: Channel<ByteArray>
) {
