...
class ConcentricSubnet(
    ...
    private val members = mutableSetOf<NUID>()
    private val gatewayNodes = mutableSetOf<NUID>()
    private val subnetRoutingTable: RoutingTable? = null // Optional dedicated routing table
...
class SubnetManager(
    ...
    private val subnets = mutableMapOf<String, ConcentricSubnet>()
    private val nodeSubnets = mutableMapOf<NUID, MutableSet<String>>()
