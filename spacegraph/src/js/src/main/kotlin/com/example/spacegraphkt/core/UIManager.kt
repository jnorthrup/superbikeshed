...
actual class UIManager actual constructor(
    ...
    internal var dragOffset: THREE.Vector3 = THREE.Vector3() // Offset from node origin to drag point

    internal val pointerState: PointerState = PointerState() // Current pointer interaction state
    internal var confirmCallback: (() -> Unit)? = null // Callback for 'Yes' in confirm dialog
    ...
    internal fun _createDefaultContextMenuElement(): HTMLDivElement =
    ...
    internal fun _createDefaultConfirmDialogElement(): HTMLDivElement =
        (document.createElement("div") as HTMLDivElement).apply {
    ...
    /** Creates and styles a default HTML element for status messages. @return The created [HTMLDivElement]. @internal */
     internal fun _createDefaultStatusIndicatorElement(): HTMLDivElement =
        (document.createElement("div") as HTMLDivElement).apply {
    ...
    internal fun _getTargetInfo(event: PointerEvent): TargetInfo {
    ...
    internal fun _onPointerUp(e: PointerEvent) {
    ...
    internal fun _onDocumentClick(e: MouseEvent) { // Use MouseEvent as it's a general click
    ...
    internal fun _hideConfirm() { confirmDialogElement.style.display = "none"; this.confirmCallback = null }
    /** Handles 'Yes' click in confirm dialog. @internal */
    internal fun _onConfirmYes() { this.confirmCallback?.invoke(); _hideConfirm() }
