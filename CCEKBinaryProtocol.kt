...
object SimpleBinaryProtocol {
    ...
    class BinaryProtocolChoreographer {
        ...
        private fun decodeMessage(buf: ByteIndexedBuffer): Message? {
        ...
        private fun validateMessage(msg: Message?, knowledge: Knowledge): Message? {
            msg ?: return null
...
object FrameProtocol {
    ...
    class FrameProtocolProcessor {
        ...
        private fun parseFrame(buf: ByteIndexedBuffer): Frame? {
        ...
        private fun transformFrame(frame: Frame?, knowledge: Knowledge): Frame? {
            frame ?: return null
...
private fun ByteIndexedBuffer.extractBytes(start: Int, end: Int): ByteArray {
    val saved = pos
    pos(start)
