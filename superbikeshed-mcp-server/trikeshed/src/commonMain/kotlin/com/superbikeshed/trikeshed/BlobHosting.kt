...
class CouchDBBlobHosting(
    private val couchDB: CouchDBConnection
) : BlobHostingService {
    ...
    private fun detectContentType(blob: ByteArray): String {
    ...
    private fun computeHash(blob: ByteArray): String {
...
class ViolaBlobSupport(
    private val blobHosting: BlobHostingService
) {
