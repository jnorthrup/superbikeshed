...
abstract class IPCHost(
    ...
    protected val channels = mutableMapOf<ChannelId, IPCChannel>()
    ...
    protected fun generateMessageId(): MessageId = ++messageCounter
}
 ...
 */
class IPCBuilder {
    private var hostId: ProcessId = 0
    private var transportType: TransportType = TransportTypes.NATIVE
    private val channelConfigs = mutableMapOf<ChannelId, IPCChannelConfig>()
