...
object TradingDataParser {
    ...
    private fun parseTradingData(scanner: JsonScanner): TradingData {
        var symbol = ""
        var timeframe = ""
    ...
    private fun parseCandle(scanner: JsonScanner): Candle {
        var timestamp = 0L
        var open = 0.0
        var high = 0.0
        var low = 0.0
    ...
    private fun parseDoubleArray(scanner: JsonScanner): List<Double> {
...
class JsonScanner(private val json: String) {
    private var pos = 0
