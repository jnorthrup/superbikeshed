...
internal var agentApiInstance: AgentAPI? = null
internal var demoVisualizerInstance: DemoVisualizer? = null

internal var currentKlineDataSeries: Indexed<Kline>? = null
internal var currentAugmentedVisualSeries: Indexed<VisualGraphPointWithMoneyfanOutcome>? = null

// Default values for UI elements, matching index.html defaults
internal const val DEFAULT_ASSET_SYMBOL = "BTC"
internal const val DEFAULT_BASELINE = 50000.0
internal const val DEFAULT_SHORT_SMA = 10
internal const val DEFAULT_LONG_SMA = 20
internal const val DEFAULT_RSI_PERIOD = 14
