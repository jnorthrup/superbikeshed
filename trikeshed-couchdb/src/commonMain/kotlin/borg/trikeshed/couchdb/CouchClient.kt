...
interface CouchClient {
    ...
    internal fun buildViewQueryString(params: CouchViewParams): String {
    ...
    internal fun parseDatabaseInfo(body: ByteArray): CouchDatabaseInfo? {
        return try {
    ...
    internal fun parsePutResult(body: ByteArray): CouchPutResult {
        return json.decodeFromString(CouchPutResult.serializer(), body.decodeToString())
    }
    
    internal fun parseDocument(body: ByteArray): CouchDocumentData {
    ...
    internal fun parseBulkResults(body: ByteArray): List<CouchBulkResult> {
        return json.decodeFromString(ListSerializer(CouchBulkResult.serializer()), body.decodeToString())
    }
    
    internal fun parseChanges(body: ByteArray): List<CouchChange> {
        val jsonObject = json.parseToJsonElement(body.decodeToString()).jsonObject
    ...
    internal fun parseReplicationResult(body: ByteArray): CouchReplicationResult {
        return json.decodeFromString(CouchReplicationResult.serializer(), body.decodeToString())
    }
    
    internal fun parseViewResult(body: ByteArray): CouchViewResult {
        return json.decodeFromString(CouchViewResult.serializer(), body.decodeToString())
    }
    
    internal fun parseSecurity(body: ByteArray): CouchSecurity {
