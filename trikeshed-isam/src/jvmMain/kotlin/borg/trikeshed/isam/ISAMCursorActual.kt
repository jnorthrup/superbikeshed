...
actual class ISAMCursor actual constructor(
    ...
    private val metadata: ISAMMetadata
) : Cursor {
    ...
    private fun getRow(rowIndex: Int): RowVec {
    ...
    private fun parseValue(data: ByteArray, type: IOMemento): Any? {
...
private fun serializeValue(value: Any?, type: IOMemento, maxSize: Int): ByteArray {
    return when (type) {
        IOMemento.IoInt -> {
