...
class JvmSSHTransportService(internal val context: CoroutineContext) : SSHTransportService {
    internal var channel: AsynchronousSocketChannel? = null
...
// JVM Crypto Service
class JvmSSHCryptoService(internal val context: CoroutineContext) : SSHCryptoService {
...
// JVM Channel Service
class JvmSSHChannelService(internal val context: CoroutineContext) : SSHChannelService {
    internal val channels = mutableMapOf<SSHChannelID, SSHChannel>()
    internal var nextChannelId = 0u
...
// JVM Session Service
class JvmSSHSessionService(internal val context: CoroutineContext) : SSHSessionService {
    internal val sessions = mutableMapOf<SSHSessionID, SSHSession>()
