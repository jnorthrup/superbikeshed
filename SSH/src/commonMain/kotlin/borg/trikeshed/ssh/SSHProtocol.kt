...
enum class SSHMessageType(val value: Byte) {
    ...
    companion object {
        internal val map = values().associateBy(SSHMessageType::value)
...
enum class SSHDisconnectReason(val code: UInt) {
    ...
    companion object {
        internal val map = values().associateBy(SSHDisconnectReason::code)
...
enum class SSHChannelOpenFailure(val code: UInt) {
    ...
    companion object {
        internal val map = values().associateBy(SSHChannelOpenFailure::code)
        fun fromCode(code: UInt) = map[code]
    }
}
...
enum class SSHChannelType(val typeName: String) {
    ...
    companion object {
        internal val map = values().associateBy(SSHChannelType::typeName)
...
enum class SSHChannelRequest(val requestType: String) {
    ...
    companion object {
        internal val map = values().associateBy(SSHChannelRequest::requestType)
...
enum class SSHGlobalRequest(val requestType: String) {
    ...
    companion object {
        internal val map = values().associateBy(SSHGlobalRequest::requestType)
        fun fromType(type: String) = map[type]
    }
}
...
enum class SSHService(val serviceName: String) {
    ...
    companion object {
        internal val map = values().associateBy(SSHService::serviceName)
        fun fromName(name: String) = map[name]
    }
}
...
enum class SSHAuthMethod(val methodName: String) {
    ...
    companion object {
        internal val map = values().associateBy(SSHAuthMethod::methodName)
        fun fromName(name: String) = map[name]
    }
}
...
enum class SSHSignalType(val signalName: String) {
    ...
    companion object {
        internal val map = values().associateBy(SSHSignalType::signalName)
        fun fromName(name: String) = map[name]
    }
}
...
enum class SSHTerminalMode(val opcode: Byte) {
    ...
    companion object {
        internal val map = values().associateBy(SSHTerminalMode::opcode)
...
enum class SSHExtendedDataType(val type: UInt) {
    ...
    companion object {
        internal val map = values().associateBy(SSHExtendedDataType::type)
...
enum class SSHKeyCipher(val algorithm: String) {
    ...
    companion object {
        internal val map = values().associateBy(SSHKeyCipher::algorithm)
...
enum class SSHHashAlgorithm(val algorithm: String) {
    ...
    companion object {
        internal val map = values().associateBy(SSHHashAlgorithm::algorithm)
        fun fromName(name: String) = map[name]
    }
}
