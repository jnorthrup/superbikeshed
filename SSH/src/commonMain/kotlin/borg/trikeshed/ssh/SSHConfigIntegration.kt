...
class SSHConfigAwareBuilder {
    private val builder = SSHBuilder()
    private var configReader: SSHConfigReader? = null
    private var keyReader: SSHKeyReader? = null
    private var configFile: SSHConfigFile? = null
...
class DefaultSSHConfigReader(
    ...
    private val fileLocator: SSHFileLocator = SSHFileLocator()
) : SSHConfigReader {
    ...
    private suspend fun expandIncludes(content: String): String {
...
class SSHHostKeyVerifier(
    private val reader: SSHConfigReader = DefaultSSHConfigReader()
) {
    private var knownHosts: SSHKnownHostsFile? = null
    ...
    private fun matchesHost(hostname: String, port: Int, pattern: String): Boolean {
    ...
    private fun matchesHashedHost(host: String, hashedPattern: String): Boolean {
    ...
    private fun keysEqual(key1: SSHPublicKey, key2: SSHPublicKey): Boolean {
