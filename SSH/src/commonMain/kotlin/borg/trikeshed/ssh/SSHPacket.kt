...
class SSHPacketEncoder(
    private val crypto: SSHCryptoService,
    private val context: SSHTransportContext
) {
    suspend fun encode(
    ...
    private fun createPacket(payload: SSHPayload): SSHPacket {
    ...
    private fun generatePadding(length: Int): Indexed<Byte> {
...
class SSHPacketDecoder(
    ...
    private fun parsePacket(data: SSHPayload): SSHPacket? {
