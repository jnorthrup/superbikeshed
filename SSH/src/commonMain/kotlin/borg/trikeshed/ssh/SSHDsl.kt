...
// Main SSH builder
class SSHBuilder {
    internal var transport: TransportConfig? = null
    internal var auth: AuthConfig? = null
    internal var channels: ChannelConfig? = null
    internal var algorithms: AlgorithmConfig? = null
    internal var context: CoroutineContext = Dispatchers.Default
...
class AuthConfig {
    ...
    internal val methods = mutableListOf<AuthMethodConfig>()
...
class ChannelConfig {
    internal val channelConfigs = mutableListOf<ChannelTypeConfig>()
...
class ForwardingConfig : ChannelTypeConfig() {
    internal val localForwards = mutableListOf<LocalForward>()
    internal val remoteForwards = mutableListOf<RemoteForward>()
    internal val dynamicForwards = mutableListOf<DynamicForward>()
...
// Helper functions
internal fun generateEphemeralIdentity(): SSHIdentity {
...
class SFTPBuilder(internal val session: SSHSession) {
