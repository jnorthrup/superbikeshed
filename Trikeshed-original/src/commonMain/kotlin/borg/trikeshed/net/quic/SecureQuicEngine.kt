...
class SecureQuicEngine(
    ...
    // Connection state
    private var connectionState = QuicConnectionState()
    ...
    private fun processCryptoFrame(frame: CryptoFrame): List<QuicPacket> {
    ...
    private fun createClientHello(): CryptoFrame {
        return CryptoFrame(
            offset = 0L,
    ...
    private fun createServerHello(): CryptoFrame {
        return CryptoFrame(
            offset = 0L,
    ...
    private fun createInitialHeader(): QuicHeader {
        return QuicHeader(
    ...
    private fun <T> List<T>.toIdx(): Indexed<T> {
        return this.size j { i: Int -> this[i] }
    }
    
    private fun String.toIdx(): Indexed<Byte> {
