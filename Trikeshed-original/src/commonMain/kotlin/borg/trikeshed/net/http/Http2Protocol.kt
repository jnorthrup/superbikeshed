...
class Http2Protocol {
    ...
    class Http2Stream(
        ...
        private val pendingHeaders = mutableListOf<Indexed<Byte>>()
        private val pendingData = mutableListOf<Indexed<Byte>>()
    ...
    class Http2Connection(
        ...
        private val remoteSettings = mutableMapOf<SettingsParameter, Int>()
        
        // Flow control
        private var localWindowSize = 65535
        private var remoteWindowSize = 65535
        
        // Stream ID generation
        private var nextStreamId = if (isServer) 2 else 1
...
class HpackEncoder {
    ...
    private var dynamicTableSize = 0
    private var maxDynamicTableSize = 4096
    ...
    private fun encodeInteger(output: MutableList<Byte>, value: Int, prefixBits: Int, flags: Byte) {
    ...
    private fun addToDynamicTable(name: String, value: String) {
...
class HpackDecoder {
    ...
    private fun decodeInteger(data: Indexed<Byte>, startIndex: Int, prefixBits: Int): Pair<Int, Int> {
        val maxPrefix = (1 shl prefixBits) - 1
    ...
    private fun getHeader(index: Int): Join<String, String>? {
