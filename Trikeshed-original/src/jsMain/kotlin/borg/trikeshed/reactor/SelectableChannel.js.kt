...
// JavaScript implementation using stubs (browser doesn't have direct socket access)
...
actual class SelectionKey {
    actual fun channel(): SelectableChannel = JsSelectableChannel()
    actual fun selector(): SelectorInterface = JsSelectorInterface()
...
class JsSelectableChannel : SelectableChannel {
...
class JsSelectorInterface : SelectorInterface {
