...
class SpanshISAMTest {
    ...
    fun testSuperannuation() = runBlocking {
        ...
        val archived = currentSystems.withComputedColumn(
            ...
            System.kotlinx.datetime.Clock.System.now().toEpochMilliseconds()
        }
        ...
        val recentlyArchived = archived.filterRows { row ->
            ...
            System.kotlinx.datetime.Clock.System.now().toEpochMilliseconds() - timestamp < 60000 // Within last minute
        }
