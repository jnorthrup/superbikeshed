 ...
 */
class DeflateDecoder(internal val bitStream: BitStream) {

    // Pre-defined fixed Huffman tables for DEFLATE
    // These are constant and can be built once.
    internal val fixedLitLenHuffmanTable: HuffmanLookupTable
    internal val fixedDistHuffmanTable: HuffmanLookupTable
    ...
    internal val slidingWindow = ByteArray(DEFLATE_WINDOW_SIZE) // 32KB circular buffer
    internal var windowWritePos: Int = 0 // Current write position in the circular buffer
    internal var decompressedBytesCount: Long = 0 // Total decompressed bytes

    // For collecting the final decompressed output
    internal val outputStream = ByteArrayOutputStream()
     ...
     */
    internal fun decodeNoCompressionBlock() {
     ...
     */
    internal fun decodeHuffmanBlock(
     ...
     */
    internal fun decodeDynamicHuffmanTables(): Pair<HuffmanLookupTable, HuffmanLookupTable> {
     ...
     */
    internal fun decodeLength(symbol: Int, bitStream: BitStream): Int {
     ...
     */
    internal fun decodeDistance(symbol: Int, bitStream: BitStream): Int {
     ...
     */
    internal fun writeToOutput(byte: Byte) {
     ...
     */
    internal fun copyFromSlidingWindow(length: Int, distance: Int) {
