...
class GigabyteScaleBatchProcessor {
     ...
     */
    internal suspend fun processWorkItem(
        item: WorkItem,
        config: BatchConfig,
     ...
     */
    internal fun calculateAttention(metadata: Map<String, String>): Double {
    ...
    internal data class WorkItemResult(
     ...
     */
    internal suspend fun processDocument(
        stream: InputStream,
 ...
 */
class HttpRangeScanner(internal val url: String) {
