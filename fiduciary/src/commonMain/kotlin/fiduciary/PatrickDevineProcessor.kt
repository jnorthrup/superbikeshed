...
class PatrickDevineProcessor(
     ...
     */
    internal fun parseCentralDirectoryEntry(data: ByteArray, offset: Int): ZipEntry {
     ...
     */
    internal suspend fun processZipEntry(
        archiveUrl: String,
        entry: ZipEntry
    ): DocumentAttention {
     ...
     */
    internal fun isInterestingDocument(name: String): Boolean {
...
class PatrickDevineDocumentProcessor(
    internal val processor: PatrickDevineProcessor,
    internal val fiduciaryContext: FiduciaryContext
) {
    /**
