 ...
 */
private fun kotlinx.serialization.json.JsonElement.toTrikeShedJson(): JsonElement = when (this) {
...
private fun JsonElement.toKotlinxJson(): kotlinx.serialization.json.JsonElement = when (this) {
