...
class BitmapJsonProvider(
    ...
    internal val parallelThreshold: Int = 10000,
    internal val numThreads: Int = 4
) : JsonProvider {
     ...
     */
    internal fun parseSequential(json: String): JsonElement {
     ...
     */
    internal fun parseParallel(json: String): JsonElement {
     ...
     */
    internal fun parseBitmapToElement(json: String, indices: JsonStructuralSeries): JsonElement {
...
class BitmapJsonNavigator(
    ...
    internal val structuralIndices: JsonStructuralSeries
) {
    ...
    internal fun parseObject(): Join<JsonElement, Int> {
        currentIndex++ // Skip '{'
    ...
    internal fun parseArray(): Join<JsonElement, Int> {
        currentIndex++ // Skip '['
    ...
    internal fun skipChar(expected: Char) {
    ...
    internal fun isNumberChar(c: Char): Boolean =
        c.isDigit() || c == '.' || c == '-' || c == '+' || c == 'e' || c == 'E'
    
    internal fun unescapeString(content: String): String {
...
class ParallelBitmapStreaming(
    ...
    internal val concurrency: Int = 4
) {
