...
fun createRealNexus(): WorkingNexus {
...
class RealNexus(internal val apiKey: String) {
    fun handle(request: String): String {
        // Real HTTP call to Anthropic
        ...
        return response.substringAfter("\"text\":\"")
...
class WorkingNexus {
    fun handle(request: String): String = when {
