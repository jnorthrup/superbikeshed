# GoalStrikeshed Architectural Momentum System v2.0 - Cursor Edition
...
## Cursor File Priority Override System

### File Reading Priority (Highest to Lowest)
1. **`.cursorrules`** - Primary configuration (THIS FILE)
...
- **File Context Recognition**: +5 points for recognizing file type and purpose
- **Cross-Reference Awareness**: +8 points for understanding file relationships
- **IDE Feature Utilization**: +6 points for using Cursor-specific features
- **Contextual Search**: +7 points for relevant codebase exploration
...
### IDE Integration
- **File Operations**: Use Cursor's file editing capabilities for precise code changes
- **Search Integration**: Leverage codebase search to understand existing patterns
- **Context Awareness**: Consider the current file context and project structure
- **Incremental Development**: Make small, focused changes that build upon each other

### Code Generation Style
- **IDE-Friendly Code**: Generate code that works well with IntelliJ IDEA features
- **Import Management**: Include proper imports and package declarations
- **Type Inference**: Leverage Kotlin's type inference while maintaining clarity
- **Refactoring Support**: Write code that can be easily refactored using IDE tools
...
8. **IDE Integration (`N++`):** Extend the chain by using Cursor's capabilities to make precise, contextual edits.
...
- **Context Ignorance:** Making changes without considering the broader codebase context.
...
9. **Axiom of IDE Harmony:** Code should work seamlessly with development tools.
...
- **IDE-Friendly Patterns**: Use patterns that work well with refactoring tools
...
- Use Cursor's file editing capabilities for precise changes
- Consider the broader codebase context when making changes
- Leverage search and navigation features to understand existing patterns
