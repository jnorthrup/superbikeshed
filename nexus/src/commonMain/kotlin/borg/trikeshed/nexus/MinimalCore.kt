...
/**
 * Join<A,B> - Universal binary composition
 */
interface Join<A, B> {
    val a: A
    val b: B
 ...
 */
data class SimpleJoin<A, B>(override val a: A, override val b: B) : Join<A, B>

/**
 * Infix operator for Join creation
 */
infix fun <A, B> A.j(other: B): Join<A, B> = SimpleJoin(this, other)
