...
actual interface ProcessExecutionService {
    actual suspend fun executeProcess(
        ...
        println("Warning: ProcessExecutionService.executeProcess is not implemented for native target.")
        // For a more robust stub, one might return a specific error ProcessResult:
        // return ProcessResult(
        //     exitCode = -1, // Or a specific error code
        //     stdout = "",
        //     stderr = "Process execution is not implemented on this native platform.",
        //     timedOut = false,
        //     exception = "NotImplementedError"
        // )
        throw NotImplementedError("Process execution is not available on this native platform.")
    }
...
class NativeProcessExecutionService : ProcessExecutionService by object : ProcessExecutionService {}
