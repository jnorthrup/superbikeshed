 ...
 * @property moduleGroupId The group ID of the module, typically from its build file (e.g., Maven groupId).
 * @property moduleVersion The version of the module, typically from its build file.
...
data class ModuleDetails(
    ...
    val imlPath: String,
    val moduleGroupId: String? = null, // Added
    val moduleVersion: String? = null, // Added
 ...
 * @property projectGroupId The group ID of the project, typically from its build file (e.g., Maven groupId).
 * @property projectVersion The version of the project, typically from its build file.
...
data class IntelliJProjectDetails(
    ...
    val projectGroupId: String? = null, // Added
    val projectVersion: String? = null, // Added
