...
class FormationSystem(private val config: FormationConfig) {
    companion object {
        private const val DEFAULT_UNIT_SIZE = 10f
    }
    ...
    private fun findLeader(unit: Unit, gameState: GameState): Unit? {
    ...
    private fun updateLeader(unit: Unit): Unit {
    ...
    private fun updateFollower(unit: Unit, leader: Unit): Unit {
    ...
    private fun predictLeaderPosition(leader: Unit): Position {
    ...
    private fun calculateIdealFormationSlot(unit: Unit, leaderPosition: Position): Position {
    ...
    private fun calculateSteeringForces(unit: Unit, targetPosition: Position): Position {
    ...
    private fun calculateSeekForce(unit: Unit, targetPosition: Position): Position {
    ...
    private fun calculateSeparationForce(unit: Unit): Position {
    ...
    private fun calculateTerrainAvoidanceForce(unit: Unit): Position {
        // TODO: Implement terrain avoidance using feeler
        return Position(0f, 0f)
    }

    private fun applySteeringForces(
        unit: Unit,
        steering: Position,
