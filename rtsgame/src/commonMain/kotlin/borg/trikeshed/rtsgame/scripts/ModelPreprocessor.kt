 ...
 */
class ModelPreprocessor(private val config: ModelPreprocessorConfig = ModelPreprocessorConfig()) {
     ...
     */
    private suspend fun processObjFile(fileName: String): PreprocessingResult? {
