...
fun testPathfinding() {
    ...
    val path = pathfinder.findPath(50.0, 50.0, 750.0, 750.0)
    
    if (path != null && path.a > 0) {
        println("Pathfinding test passed - found path with ${path.a} waypoints")
        
        // Print first few waypoints
        val waypoints = minOf(5, path.a)
