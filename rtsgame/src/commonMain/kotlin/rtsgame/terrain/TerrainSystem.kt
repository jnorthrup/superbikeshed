 ...
 */
class TerrainSystem(private val random: DeterministicRandom) {
    ...
    private val terrain: Array<Array<TerrainTile?>> = Array(GRID_SIZE) { arrayOfNulls(GRID_SIZE) }
    private val resourceNodes = mutableListOf<ResourceNode>()
    private var generationSeed: Long = 0
    ...
    private fun generateBaseTerrain() {
    ...
    private fun generateNoise(x: Int, y: Int, seed: Long): Double {
    ...
    private fun generateElevation(x: Int, y: Int): Double {
    ...
    private fun placeResourceNodes() {
        resourceNodes.clear()
    ...
    private fun ensureConnectivity() {
    ...
    private fun createBridges(visited: Array<BooleanArray>, landTiles: List<Pair<Int, Int>>) {
    ...
    private fun createPath(startX: Int, startY: Int, endX: Int, endY: Int) {
        var currentX = startX
        var currentY = startY
    ...
    private fun getNeighbors(x: Int, y: Int): List<TerrainTile?> {
