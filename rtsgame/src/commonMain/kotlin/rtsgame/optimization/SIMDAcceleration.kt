...
class CacheOptimizedStorage<T : Component>(
    ...
    private val structSize: Int,
    initialCapacity: Int = 1024
) : ComponentStorage<T>() {
    // Hot data in contiguous arrays
    private var hotData = FloatArray(initialCapacity * structSize)
    private var coldData = Array<Any?>(initialCapacity) { null }
    private var capacity = initialCapacity
    private var count = 0
    
    // Prefetch hints
    private val prefetchDistance = 8
    ...
    private fun packHotData(index: Int, component: T) {
    ...
    private fun swapData(index1: Int, index2: Int) {
        // Swap hot data
...
class GPUComputeAcceleration {
    private lateinit var computeDevice: GPUDevice
    private lateinit var positionBuffer: GPUBuffer
    private lateinit var velocityBuffer: GPUBuffer
    private lateinit var outputBuffer: GPUBuffer
...
object BranchlessOptimizations {
    ...
    private infix fun Float.ushr(bits: Int): Int {
