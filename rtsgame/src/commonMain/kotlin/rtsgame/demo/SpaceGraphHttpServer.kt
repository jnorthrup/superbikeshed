...
class SpaceGraphHttpServer {
    ...
    private val spaceGraphRenderer = RTSSpaceGraphRenderer()
    private val webgpuRenderer = CommonWebGPUSpaceGraph()
    
    private var currentGameState: GameState? = null
    private var currentCamera: CameraState? = null
    ...
    private fun serveHtmlPage(request: HttpRequest): HttpResponse {
        val html = """
            <!DOCTYPE html>
            <html>
            <head>
    ...
    private fun serveGameState(request: HttpRequest): HttpResponse {
    ...
    private fun serveRenderFrame(request: HttpRequest): HttpResponse {
        val gameState = currentGameState ?: throw IllegalStateException("Game state not initialized")
    ...
    private fun updateGameState(request: HttpRequest): HttpResponse {
        val gameState = currentGameState ?: throw IllegalStateException("Game state not initialized")
    ...
    private fun createDefaultCamera(): CameraState {
        return CameraState(
