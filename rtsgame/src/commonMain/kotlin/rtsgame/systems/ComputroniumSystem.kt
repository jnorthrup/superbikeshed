...
class ComputroniumManager(val team: String) {
    ...
    private var computroniumCores = mutableListOf<ComputroniumCore>()
    private var activeProcesses = mutableListOf<ComputationalProcess>()
    
    // Efficiency tracking
    private var lastEfficiencyUpdate: Long = 0
    private var currentEfficiency: Double = 1.0
    private var diningPhilosophersContention: Double = 0.0
    
    // Proof of Work state
    private var proofOfWorkQueue = mutableListOf<ProofOfWorkTask>()
    private var completedProofs: Int = 0
    ...
    private fun updateCores(simulation: rtsgame.core.Simulation, deltaTime: Double) {
    ...
    private fun calculateCoreEfficiency(core: Building, allBuildings: List<Building>): Double {
        // Base efficiency
    ...
    private fun processComputationalTasks(deltaTime: Double) {
    ...
    private fun completeProcess(process: ComputationalProcess) {
        when (process.type) {
    ...
    private fun processProofOfWork(simulation: rtsgame.core.Simulation, deltaTime: Double) {
    ...
    private fun executeProofOfWorkResult(task: ProofOfWorkTask, simulation: rtsgame.core.Simulation) {
        when (task.operation) {
    ...
    private fun getEnemyComputroniumManagers(simulation: rtsgame.core.Simulation): List<ComputroniumManager> {
