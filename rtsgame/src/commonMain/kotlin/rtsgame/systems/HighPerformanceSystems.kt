...
class SteeringSystem : System {
    ...
    private fun applySeek(pos: PositionComponent, vel: VelocityComponent, physics: PhysicsComponent, target: PositionComponent) {
    ...
    private fun applyPursuit(pos: PositionComponent, vel: VelocityComponent, physics: PhysicsComponent, 
    ...
    private fun applyFlee(pos: PositionComponent, vel: VelocityComponent, physics: PhysicsComponent, threat: PositionComponent) {
...
class CombatSystem : System {
    private data class DamageEvent(val attacker: EntityId, val target: EntityId, val damage: Float)
    private val damageQueue = mutableListOf<DamageEvent>()
    ...
    private fun processDamageQueue(world: ECSWorld) {
    ...
    private fun findEntitiesInRange(world: ECSWorld, center: PositionComponent, range: Float): List<EntityId> {
...
class FlowFieldPathfindingSystem : System {
    private val flowFields = mutableMapOf<Int, FlowField>()
    ...
    private fun updateFlowFields(world: ECSWorld) {
    ...
    private fun calculateFlowField(targets: List<PositionComponent>): FlowField {
...
class FormationSystem : System {
    ...
    private fun getFormationOffset(type: FormationType, position: Int, spacing: Float): Pair<Float, Float> {
        return when (type) {
