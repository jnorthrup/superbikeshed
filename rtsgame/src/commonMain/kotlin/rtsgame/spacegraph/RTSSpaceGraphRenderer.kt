...
class RTSSpaceGraphRenderer(
    ...
    private fun convertEntityToNode(entity: Entity): SpaceGraphNode {
    ...
    private fun convertToWorldPosition(gamePos: Position): Vector3D {
        return Vector3D(
    ...
    private fun determineEntityType(entity: Entity): EntityType {
    ...
    private fun determineConnectionType(entity1: Entity, entity2: Entity): ConnectionType {
        return when {
