...
class RTSRequestFactory(
    ...
    private val requestHistory = mutableListOf<RTSRequest>()
    ...
    private fun processMoveUnit(request: RTSRequest.MoveUnit): RTSResponse {
    ...
    private fun processAttackTarget(request: RTSRequest.AttackTarget): RTSResponse {
    ...
    private fun processStopUnit(request: RTSRequest.StopUnit): RTSResponse {
    ...
    private fun processBuildStructure(request: RTSRequest.BuildStructure): RTSResponse {
    ...
    private fun processQueueUnit(request: RTSRequest.QueueUnit): RTSResponse {
    ...
    private fun processCancelProduction(request: RTSRequest.CancelProduction): RTSResponse {
    ...
    private fun processSetRallyPoint(request: RTSRequest.SetRallyPoint): RTSResponse {
    ...
    private fun processAIOverride(request: RTSRequest.AIDecisionOverride): RTSResponse {
    ...
    private fun processSimulationTick(request: RTSRequest.SimulationTick): RTSResponse {
        // Update simulation
    ...
    private fun processPlayerJoin(request: RTSRequest.PlayerJoin): RTSResponse {
    ...
    private fun startReplay(data: Indexed<Byte>): Indexed<Byte> {
        isReplaying = true
        replayIndex = 0
    ...
    private fun stopReplay(): Indexed<Byte> {
        isReplaying = false
    ...
    private fun exportReplay(): Indexed<Byte> {
        return RTSCodec.encodeBatch(requestHistory)
    }
    
    private fun getSyncState(): Indexed<Byte> {
    ...
    private fun calculateStateChecksum(): Int {
