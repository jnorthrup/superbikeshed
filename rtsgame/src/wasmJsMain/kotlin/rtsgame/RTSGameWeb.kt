...
class RTSGameWeb(
    ...
    private lateinit var launcher: RTSGameLauncher
    private lateinit var renderer: WebGPUOptimizedRenderer
    private var isPaused = false
    
    // Selection state
    private val selectedUnits = mutableSetOf<EntityId>()
    ...
    private fun screenToWorld(x: Int, y: Int): PositionComponent {
        // Convert screen coordinates to world coordinates
        return PositionComponent(x.toFloat(), y.toFloat())
    }
    
    private fun worldToScreen(pos: PositionComponent): ScreenPos {
