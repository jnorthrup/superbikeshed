...
class SimulationManager {
    ...
    update(deltaTime) {
        if (this.gameContext.gameState.paused)
            return;
        // Update game time
        ...
        if (this.gameContext.gameState.gameTime % 60 === 0) {
            (0, strategicAI_js_1.makeStrategicDecisions)(this.createGameContext());
            (0, strategicAI_js_1.coordinateAttacks)(this.createGameContext());
        }
        // Check for game end
        this.checkGameEnd();
    }
