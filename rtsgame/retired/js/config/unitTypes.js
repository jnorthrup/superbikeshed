...
const UNIT_TYPES = {
    tank: {
        ...
        domain: 'land',
        size: 10,
        speed: gameConstants_js_1.UNIT_SPEED * 0.7,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 1.5,
        damage: 25,
        inflictsDamageType: 'Kinetic',
        armorType: 'Heavy',
        armorValue: 50,
        alloyType: 'AEGIS_STEEL', // Tanks benefit from heavy armor
        range: gameConstants_js_1.UNIT_ATTACK_RANGE * 1.2,
        attackSpeed: gameConstants_js_1.UNIT_ATTACK_COOLDOWN * 1.2,
        buildTime: 240,
        color: '#4a90e2',
        effectColor: '#ff0',
    ...
    bot: {
        ...
        domain: 'land',
        size: 6,
        speed: gameConstants_js_1.UNIT_SPEED * 2,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 0.7,
        damage: 10,
        inflictsDamageType: 'Kinetic',
        armorType: 'Light',
        armorValue: 10,
        alloyType: 'QUICKSILVER_WEAVE', // Bots are fast, light
        range: gameConstants_js_1.UNIT_ATTACK_RANGE * 0.8,
        attackSpeed: gameConstants_js_1.UNIT_ATTACK_COOLDOWN * 0.7,
        buildTime: 30,
        color: '#aaa',
        effectColor: '#f80',
    ...
    artillery: {
        ...
        domain: 'land',
        size: 12,
        speed: gameConstants_js_1.UNIT_SPEED * 0.5,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 0.8,
        damage: 40,
        inflictsDamageType: 'Kinetic', // Could be explosive, but Kinetic is a good base
        armorType: 'Medium',
        armorValue: 30,
        alloyType: 'STANDARD_PLASTEEL',
        range: gameConstants_js_1.UNIT_ATTACK_RANGE * 3,
        attackSpeed: gameConstants_js_1.UNIT_ATTACK_COOLDOWN * 2,
        buildTime: 300,
        color: '#4a90e2',
        effectColor: '#f00',
    ...
    battleship: {
        ...
        domain: 'sea',
        size: 20,
        speed: gameConstants_js_1.UNIT_SPEED * 0.8,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 1.2,
        damage: 40,
        inflictsDamageType: 'Kinetic',
        armorType: 'Heavy',
        armorValue: 60,
        alloyType: 'AEGIS_STEEL',
        range: gameConstants_js_1.UNIT_ATTACK_RANGE * 1.5,
        attackSpeed: gameConstants_js_1.UNIT_ATTACK_COOLDOWN * 1.5,
        buildTime: 120,
        color: '#048',
        effectColor: '#0ff',
        cost: { mass: 200, energy: 150 },
    ...
    submarine: {
        ...
        domain: 'sea',
        size: 15,
        speed: gameConstants_js_1.UNIT_SPEED * 1.2,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 0.9,
        damage: 30, // Torpedoes - could be Kinetic or a specialized type
        inflictsDamageType: 'Kinetic',
        armorType: 'Medium',
        armorValue: 35,
        alloyType: 'STANDARD_PLASTEEL',
        range: gameConstants_js_1.UNIT_ATTACK_RANGE * 1.8,
        attackSpeed: gameConstants_js_1.UNIT_ATTACK_COOLDOWN * 1.8,
        buildTime: 80,
        color: '#026',
        effectColor: '#088',
    ...
    fighter: {
        ...
        domain: 'air',
        size: 8,
        speed: gameConstants_js_1.UNIT_SPEED * 4,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 0.6,
        damage: 15,
    ...
    bomber: {
        ...
        size: 12,
        speed: gameConstants_js_1.UNIT_SPEED * 2,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 1.0,
        ...
        range: gameConstants_js_1.UNIT_ATTACK_RANGE * 1.0, // Represents drop range
        attackSpeed: gameConstants_js_1.UNIT_ATTACK_COOLDOWN * 1.0,
        buildTime: 100,
        color: '#999',
        effectColor: '#ff8',
    ...
    gunship: {
        ...
        domain: 'air',
        size: 10,
        speed: gameConstants_js_1.UNIT_SPEED * 3,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 0.8,
        damage: 25,
        inflictsDamageType: 'Kinetic',
        armorType: 'Medium',
    ...
    engineer: {
        ...
        domain: 'land',
        size: 8,
        speed: gameConstants_js_1.UNIT_SPEED * 0.9,
        speedLand: gameConstants_js_1.UNIT_SPEED * 0.9,
        speedWater: gameConstants_js_1.UNIT_SPEED * 0.9,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 0.6,
        ...
        armorValue: 5,
        alloyType: 'STANDARD_PLASTEEL',
        range: gameConstants_js_1.UNIT_ATTACK_RANGE * 0.5,
        attackSpeed: gameConstants_js_1.UNIT_ATTACK_COOLDOWN * 0.5,
        buildTime: 180,
        color: '#4a90e2',
        effectColor: '#0f0',
    ...
    experimental: {
        ...
        size: 25,
        speed: gameConstants_js_1.UNIT_SPEED * 0.5,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 5.0,
        damage: 100,
        inflictsDamageType: 'Energy', // Assuming a powerful energy weapon
        armorType: 'Heavy',
        armorValue: 80,
        alloyType: 'AEGIS_STEEL', // Experimental units are tough
        range: gameConstants_js_1.UNIT_ATTACK_RANGE * 2.0,
        attackSpeed: gameConstants_js_1.UNIT_ATTACK_COOLDOWN * 40, // Very slow firing
        buildTime: 300,
        color: '#f0f',
        effectColor: '#f0f',
    ...
    commander: {
        ...
        size: 18,
        speed: gameConstants_js_1.UNIT_SPEED * 0.8,
        speedLand: gameConstants_js_1.UNIT_SPEED * 0.8,
        speedWater: gameConstants_js_1.UNIT_SPEED * 0.8,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 2,
        damage: 20,
        inflictsDamageType: 'Kinetic',
        armorType: 'Medium',
        armorValue: 40,
        ...
        range: gameConstants_js_1.UNIT_ATTACK_RANGE * 1.5,
        attackSpeed: gameConstants_js_1.UNIT_ATTACK_COOLDOWN * 0.8,
        color: '#4a90e2',
        effectColor: '#f0f',
    ...
    ai_commander: {
        ...
        domain: 'land',
        size: 15,
        speed: gameConstants_js_1.UNIT_SPEED * 1.5,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 800, // Base HP, shields are separate
        maxShields: 300,
        shieldRegenRate: 5,
        damage: 40,
        ...
        range: gameConstants_js_1.UNIT_ATTACK_RANGE * 200, // Assuming these are game units, not pixels
        attackSpeed: gameConstants_js_1.UNIT_ATTACK_COOLDOWN * 20,
        buildTime: 300,
        color: '#0ff',
        effectColor: '#0af',
    ...
    quantum_scout: {
        ...
        size: 8,
        speed: gameConstants_js_1.UNIT_SPEED * 4,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 150,
        maxShields: 100,
        shieldRegenRate: 8,
        ...
        range: gameConstants_js_1.UNIT_ATTACK_RANGE * 250,
        attackSpeed: gameConstants_js_1.UNIT_ATTACK_COOLDOWN * 15,
        buildTime: 120,
        color: '#f0f',
        effectColor: '#f8f',
    ...
    cyber_warfare_unit: {
        ...
        domain: 'land',
        size: 10,
        speed: gameConstants_js_1.UNIT_SPEED * 1.8,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 200,
        maxShields: 150,
        shieldRegenRate: 6,
        ...
        range: gameConstants_js_1.UNIT_ATTACK_RANGE * 180, // Range for its abilities
        attackSpeed: gameConstants_js_1.UNIT_ATTACK_COOLDOWN * 25,
        buildTime: 180,
        color: '#808',
        effectColor: '#a0a',
    ...
    quantum_tank: {
        ...
        size: 14,
        speed: gameConstants_js_1.UNIT_SPEED * 1.2,
        maxHp: gameConstants_js_1.UNIT_HEALTH * 400,
        maxShields: 200,
        shieldRegenRate: 4,
        damage: 60,
        ...
        range: gameConstants_js_1.UNIT_ATTACK_RANGE * 220,
        attackSpeed: gameConstants_js_1.UNIT_ATTACK_COOLDOWN * 40,
        buildTime: 240,
        color: '#048',
        effectColor: '#06a',
