...
class MovementSystem(private val gameMap: GameMap) {
    private val pathfinder = Pathfinder(gameMap)
    ...
    private fun updateUnitMovement(unit: Unit, deltaTime: Float): Unit {
