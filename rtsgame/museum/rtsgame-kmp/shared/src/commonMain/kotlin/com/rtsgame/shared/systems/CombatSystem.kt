...
class CombatSystem(private val gameMap: GameMap) {
    private val damageTypeEffectiveness = mapOf(
    ...
    private fun isInRange(attacker: Unit, target: Entity): Boolean {
    ...
    private fun calculateDamage(attacker: Unit, target: Entity): Float {
    ...
    private fun applyDamage(target: Entity, damage: Float): Entity {
    ...
    private fun regenerateShield(entity: Entity): Entity {
        val newShield = min(
