...
class ResourceSystem(private val gameMap: GameMap) {
    private val resourceNodes = mutableMapOf<String, ResourceNode>()
    ...
    private fun updateUnitGathering(unit: Unit, deltaTime: Float): Unit {
