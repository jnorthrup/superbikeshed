...
exports.battleReplay = exports.BattleReplay = void 0;
...
class BattleReplay {
    ...
    loadBattle(battleId) {
        const battle = battleJournal_js_1.battleJournal.loadBattle(battleId);
        if (!battle) {
    ...
    updateReplay() {
        if (!this.isReplaying || !this.gameContext)
            return false;
        this.replayFrame++;
    ...
    executeCommand(command) {
        ...
        try {
            ...
            if (command.rngCallCount !== undefined) {
                ...
                while (deterministicRNG_js_1.gameRNG.callCount < command.rngCallCount) {
                    deterministicRNG_js_1.gameRNG.random(); // Advance to correct state
                }
            }
            switch (commandType) {
                case 'UNIT_MOVE':
    ...
    replayBuildStructure(data) {
        ...
        if (builder && ((_a = builder.type.buildList) === null || _a === void 0 ? void 0 : _a.includes(structureType))) {
    ...
    replaySpawnUnit(data) {
        ...
        if (factory && ((_a = factory.type.produces) === null || _a === void 0 ? void 0 : _a.includes(unitType))) {
    ...
    stopReplay() {
        this.isReplaying = false;
        (0, deterministicRNG_js_1.disableDeterministicMode)();
        // Reset replay state
        this.replayFrame = 0;
        this.replayTime = 0;
        this.nextCommandIndex = 0;
...
exports.battleReplay = new BattleReplay();
