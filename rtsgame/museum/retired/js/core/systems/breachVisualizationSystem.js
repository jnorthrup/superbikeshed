...
exports.BreachVisualizationSystem = void 0;
const proofOfWorkSystem_js_1 = require("./proofOfWorkSystem.js");
class BreachVisualizationSystem {
    constructor() {
    ...
    checkNewBreaches(gameContext) {
        const powSystem = gameContext.getSystem(proofOfWorkSystem_js_1.ProofOfWorkSystem);
        if (!powSystem)
            return;
    ...
    updateEffectVisuals(effect) {
        ...
        effect.currentColor = this.interpolateColor(effect.color, this.breachColors[effect.type].secondary, intensity);
    }
    ...
    getBreachStatus(entityId) {
        ...
        return {
            hasActiveBreach: (effects === null || effects === void 0 ? void 0 : effects.size) > 0,
            breachType: (_a = effects === null || effects === void 0 ? void 0 : effects.values().next().value) === null || _a === void 0 ? void 0 : _a.type,
            severity: (_b = effects === null || effects === void 0 ? void 0 : effects.values().next().value) === null || _b === void 0 ? void 0 : _b.severity,
            progress: (_c = effects === null || effects === void 0 ? void 0 : effects.values().next().value) === null || _c === void 0 ? void 0 : _c.progress,
            particleCount: particles === null || particles === void 0 ? void 0 : particles.size,
            hasOverlay: !!overlay
        };
    }
}
exports.BreachVisualizationSystem = BreachVisualizationSystem;
