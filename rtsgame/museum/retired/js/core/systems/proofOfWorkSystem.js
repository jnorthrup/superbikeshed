...
exports.ProofOfWorkSystem = void 0;
const computroniumComponent_js_1 = require("../components/computroniumComponent.js");
class ProofOfWorkSystem {
    ...
    updateNetworkHashRate(entities) {
        ...
        for (const entity of entities) {
            const computronium = entity.getComponent(computroniumComponent_js_1.ComputroniumComponent);
    ...
    determineBreachType(attacker, target) {
        const attackerComputronium = attacker.getComponent(computroniumComponent_js_1.ComputroniumComponent);
        const targetComputronium = target.getComponent(computroniumComponent_js_1.ComputroniumComponent);
    ...
    applyCoreCompromiseEffects(target, breachEffect) {
        const computronium = target.getComponent(computroniumComponent_js_1.ComputroniumComponent);
        if (computronium) {
    ...
    processCascadingEffects(breachEffect) {
        for (const cascadingEffect of breachEffect.cascadingEffects) {
            ...
            this.applyBreachEffects(target, Object.assign(Object.assign({}, cascadingEffect), { duration: breachEffect.duration * 0.7 }));
        }
    }
    getNetworkStatus() {
        return {
            ...
            breachTypes: Object.fromEntries(Array.from(this.activeBreaches.values())
                .reduce((acc, breach) => {
...
exports.ProofOfWorkSystem = ProofOfWorkSystem;
