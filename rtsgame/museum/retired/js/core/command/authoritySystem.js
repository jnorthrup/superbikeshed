...
exports.AuthoritySystem = void 0;
class AuthoritySystem {
    ...
    calculateVeterancyAuthorityModifier(unit) {
        const veterancyPoints = unit.combatExperience +
            unit.survivalTime +
    ...
    calculateEffectiveAuthority(unit, context) {
        ...
        return {
            ...
            veterancyData,
            contextModifier,
            effectiveAuthority: baseAuthority + healthModifier + (((_a = veterancyData === null || veterancyData === void 0 ? void 0 : veterancyData.bonuses) === null || _a === void 0 ? void 0 : _a.commandRadius) || 0) + contextModifier
        };
    }
...
exports.AuthoritySystem = AuthoritySystem;
