...
const resourceManager_js_1 = require("./resourceManager.js"); // Adjusted path
class GameState {
    constructor() {
        this.gameTime = 0;
        this.winner = null;
        ...
        this.playerResources = (0, resourceManager_js_1.initPlayerResources)();
        this.mapResourceNodes = (0, resourceManager_js_1.initMapResourceNodes)();
        this.units = [];
        this.buildings = [];
        this.terrain = [];
        this.resourceNodes = [];
