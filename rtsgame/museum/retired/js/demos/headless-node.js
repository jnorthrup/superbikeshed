    ...
    recordFrame(gameContext) {
        ...
        if (this.frameCount % 30 === 0) {
            this.battleData.frames.push({
                ...
                resources: {
                    blue: Object.assign({}, gameContext.resources.blue),
                    red: Object.assign({}, gameContext.resources.red)
                }
            });
        }
    }
...
if (!fs_1.default.existsSync(RECORDINGS_DIR)) {
    fs_1.default.mkdirSync(RECORDINGS_DIR);
}
// Function to save recording to file
function saveRecordingToFile(battleId, data) {
    const filename = path_1.default.join(RECORDINGS_DIR, `${battleId}.json`);
    fs_1.default.writeFileSync(filename, JSON.stringify(data, null, 2), 'utf8');
...
app.use(express_1.default.json({ limit: '50mb' })); // Increase limit for larger recordings
...
app.get('/run-headless-simulation', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log('Received request to run headless simulation...');
        const battleId = yield runNodeHeadlessTest(); // This will run the simulation and save its recording
