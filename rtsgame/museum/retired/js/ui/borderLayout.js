...
exports.WindowManager = exports.TextComponent = exports.BorderLayoutContainer = exports.BorderRegion = void 0;
...
class BorderLayoutContainer {
    constructor(x, y, width, height, options = {}) {
        ...
        this.regionSizes.set(exports.BorderRegion.NORTH, 100);
        this.regionSizes.set(exports.BorderRegion.SOUTH, 80);
        this.regionSizes.set(exports.BorderRegion.EAST, 150);
        this.regionSizes.set(exports.BorderRegion.WEST, 150);
        // State
        this.visible = true;
    ...
    updateLayout() {
        ...
        // North region
        if (this.regions.has(exports.BorderRegion.NORTH)) {
            const northHeight = Math.min(this.regionSizes.get(exports.BorderRegion.NORTH), contentHeight / 3);
            this.regionBounds.set(exports.BorderRegion.NORTH, {
                x: contentX,
                y: contentY,
                width: contentWidth,
                height: northHeight
        ...
        // South region
        if (this.regions.has(exports.BorderRegion.SOUTH)) {
            const southHeight = Math.min(this.regionSizes.get(exports.BorderRegion.SOUTH), contentHeight / 3);
            this.regionBounds.set(exports.BorderRegion.SOUTH, {
                x: contentX,
        ...
        const northHeight = this.regionBounds.has(exports.BorderRegion.NORTH) ?
            this.regionBounds.get(exports.BorderRegion.NORTH).height : 0;
        const southHeight = this.regionBounds.has(exports.BorderRegion.SOUTH) ?
            this.regionBounds.get(exports.BorderRegion.SOUTH).height : 0;
        const middleY = contentY + northHeight;
        const middleHeight = contentHeight - northHeight - southHeight;
        // West region
        if (this.regions.has(exports.BorderRegion.WEST)) {
            const westWidth = Math.min(this.regionSizes.get(exports.BorderRegion.WEST), contentWidth / 3);
            this.regionBounds.set(exports.BorderRegion.WEST, {
                x: contentX,
                y: middleY,
                width: westWidth,
                height: middleHeight
        ...
        // East region
        if (this.regions.has(exports.BorderRegion.EAST)) {
            const eastWidth = Math.min(this.regionSizes.get(exports.BorderRegion.EAST), contentWidth / 3);
            this.regionBounds.set(exports.BorderRegion.EAST, {
        ...
        const westWidth = this.regionBounds.has(exports.BorderRegion.WEST) ?
            this.regionBounds.get(exports.BorderRegion.WEST).width : 0;
        const eastWidth = this.regionBounds.has(exports.BorderRegion.EAST) ?
            this.regionBounds.get(exports.BorderRegion.EAST).width : 0;
        if (this.regions.has(exports.BorderRegion.CENTER)) {
            this.regionBounds.set(exports.BorderRegion.CENTER, {
    ...
    addComponent(component, region) {
        if (!Object.values(exports.BorderRegion).includes(region)) {
    ...
    handleMouseMove(x, y) {
        ...
        if (this.isResizing && this.resizable) {
            ...
            switch (this.resizeHandle) {
                case 'se':
                    this.setSize(Math.max(200, this.width + dx), Math.max(150, this.height + dy));
                    break;
                case 'e':
    ...
    draw(ctx) {
        ...
        this.regionBounds.forEach((bounds, region) => {
            if (region !== exports.BorderRegion.CENTER) {
...
exports.BorderLayoutContainer = BorderLayoutContainer;
