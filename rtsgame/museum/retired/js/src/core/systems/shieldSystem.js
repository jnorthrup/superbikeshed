...
exports.ShieldSystem = void 0;
const combatConstants_js_1 = require("../config/combatConstants.js");
class ShieldSystem {
    constructor() {
        this.damageTypeInteractions = {
            [combatConstants_js_1.DAMAGE_TYPES.KINETIC]: { shieldFactor: 0.8, bleedThrough: 0.2 },
            [combatConstants_js_1.DAMAGE_TYPES.ENERGY]: { shieldFactor: 0.6, bleedThrough: 0.4 },
            [combatConstants_js_1.DAMAGE_TYPES.THERMAL]: { shieldFactor: 0.7, bleedThrough: 0.3 },
            [combatConstants_js_1.DAMAGE_TYPES.EMP]: { shieldFactor: 2.0, bleedThrough: 0.1 }, // EMP is strong vs shields
            [combatConstants_js_1.DAMAGE_TYPES.CORROSIVE]: { shieldFactor: 0.9, bleedThrough: 0.1 }, // Corrosive might primarily target armor, less shield
            [combatConstants_js_1.DAMAGE_TYPES.NANITE]: { shieldFactor: 0.2, bleedThrough: 0.8 }, // Nanites might bypass shields or be ineffective
            [combatConstants_js_1.DAMAGE_TYPES.PHASE]: { shieldFactor: 0.5, bleedThrough: 0.5 } // Phase damage partially bypasses shields
        };
    }
        ...
        for (const entity of entities) {
            ...
            if (entity.shield.currentShieldHP < entity.shield.maxShieldHP) {
                ...
                if (timeSinceLastHit >= entity.shield.rechargeDelay) {
                    ...
                    entity.shield.currentShieldHP = Math.min(entity.shield.maxShieldHP, entity.shield.currentShieldHP + rechargeAmount);
                }
            }
    ...
    takeDamage(entity, damage, damageType) {
        ...
        const interaction = this.damageTypeInteractions[damageType] || this.damageTypeInteractions[combatConstants_js_1.DAMAGE_TYPES.KINETIC] || { shieldFactor: 1.0, bleedThrough: 0.0 };
