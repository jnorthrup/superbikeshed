...
exports.gameRNG = exports.DeterministicRNG = void 0;
exports.enableDeterministicMode = enableDeterministicMode;
exports.disableDeterministicMode = disableDeterministicMode;
exports.createReproducibleSeed = createReproducibleSeed;
...
exports.gameRNG = new DeterministicRNG();
// Replace Math.random with deterministic version for game logic
function enableDeterministicMode(seed = null) {
    if (seed !== null) {
        exports.gameRNG.setSeed(seed);
    }
    ...
    Math.random = () => exports.gameRNG.random();
    console.log(`🎲 Deterministic RNG enabled with seed: ${exports.gameRNG.originalSeed}`);
}
// Restore original Math.random
function disableDeterministicMode() {
    if (Math._originalRandom) {
...
function createReproducibleSeed(battleId, timestamp = Date.now()) {
