...
exports.ComputroniumManager = exports.ComputroniumCore = void 0;
 ...
 */
class ComputroniumCore {
    constructor(id, owner, efficiency = 1.0) {
        this.id = id;
        this.owner = owner; // Unit or building that owns this core
        this.efficiency = Math.max(gameConstants_js_1.COMPUTRONIUM_CONFIG.MIN_CORE_EFFICIENCY, Math.min(gameConstants_js_1.COMPUTRONIUM_CONFIG.MAX_CORE_EFFICIENCY, efficiency));
        this.isActive = true;
    ...
    getActualGenerationRate() {
        ...
        let rate = gameConstants_js_1.COMPUTRONIUM_CONFIG.BASE_GENERATION_RATE * this.efficiency;
        ...
        const contentionPenalty = activeNeighbors * gameConstants_js_1.COMPUTRONIUM_CONFIG.DINING_PHILOSOPHERS_PENALTY;
...
class ComputroniumManager {
    ...
    updateC2Bonuses() {
        ...
        this.c2LatencyBonus = Math.min(0.5, availableComputronium * gameConstants_js_1.COMPUTRONIUM_CONFIG.C2_COMPUTRONIUM_BONUS);
    ...
    updatePowCapabilities() {
        ...
        const availableComputronium = this.totalComputronium - this.reservedComputronium;
        this.powAttackCapability = Math.floor(availableComputronium / gameConstants_js_1.COMPUTRONIUM_CONFIG.COMPUTATIONAL_WARFARE_COST);
    }
    /**
    ...
    launchPowAttack(targetManager, intensity = 1) {
        const cost = intensity * gameConstants_js_1.COMPUTRONIUM_CONFIG.COMPUTATIONAL_WARFARE_COST;
...
exports.ComputroniumManager = ComputroniumManager;
