...
exports.GrenadeProjectile = void 0;
// js/core/projectile.js
const gameConstants_js_1 = require("../../config/gameConstants.js"); // If needed for drawing or physics
...
class GrenadeProjectile {
    ...
    update(gameContext) {
        ...
        if (this.x < 0 || this.x > gameConstants_js_1.WORLD_SIZE || this.y < 0 || this.y > gameConstants_js_1.WORLD_SIZE) {
...
exports.GrenadeProjectile = GrenadeProjectile;
