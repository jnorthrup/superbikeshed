...
const terrainProperties_js_1 = require("../config/terrainProperties.js");
const perlinNoiseGenerator_js_1 = require("../terrain-generators/perlinNoiseGenerator.js");
const islandGenerator_js_1 = require("../terrain-generators/islandGenerator.js");
/**
 * Terrain Manager
...
class TerrainManager {
    constructor() {
        ...
        this.registerGenerator('perlin', new perlinNoiseGenerator_js_1.PerlinNoiseGenerator());
        this.registerGenerator('island', new islandGenerator_js_1.IslandGenerator());
    }
    /**
    ...
    getTerrainProperties(terrainType) {
        return (0, terrainProperties_js_1.getTerrainProperties)(terrainType);
    }
    /**
