...
exports.CommandHierarchyUI = void 0;
const commandConfig_js_1 = require("../config/commandConfig.js");
class CommandHierarchyUI {
    ...
    render() {
        if (!this.visible || !this.selectedUnit)
            return;
        const ctx = this.ctx;
    ...
    drawVeterancyStatus(unit) {
        ...
        const progress = unit.combatExperience / commandConfig_js_1.COMMAND_CONFIG.VETERANCY_THRESHOLDS[unit.veterancyLevel];
        const barWidth = 200;
        const barHeight = 20;
        // Background
...
exports.CommandHierarchyUI = CommandHierarchyUI;
