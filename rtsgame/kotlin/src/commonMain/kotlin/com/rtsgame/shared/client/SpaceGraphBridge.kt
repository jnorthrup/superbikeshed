...
class SpaceGraphBridge(
     ...
     */
    private fun updateCommandHierarchy() {
     ...
     */
    private fun updateBreachAttempts() {
     ...
     */
    private fun updateComputroniumAllocation() {
     ...
     */
    private fun updateFormationLines() {
     ...
     */
    private fun updateResourceFlows() {
