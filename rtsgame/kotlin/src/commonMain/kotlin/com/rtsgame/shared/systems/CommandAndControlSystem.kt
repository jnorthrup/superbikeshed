...
class CommandAndControlSystem(
    ...
    private fun calculateDistanceToEntity(sourceId: Long, targetId: Long): Double {
    ...
    private fun getNearbyEntities(entityId: Long, radius: Double): List<Entity> {
        val entity = entityManager.getEntity(entityId) ?: return emptyList()
    ...
    private fun applyCommandCorrection(predicted: Command, actual: Command) {
