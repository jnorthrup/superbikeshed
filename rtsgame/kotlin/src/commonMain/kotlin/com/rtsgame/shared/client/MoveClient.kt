...
class MoveClient(
    ...
    private val networkPhysics: NetworkPhysics,
    private val cacheCoherence: CacheCoherence
) {
    ...
    // Client instances
    private val clients = mutableMapOf<Long, ClientState>()
     ...
     */
    private fun validatePlayerAction(action: PlayerAction): ValidationResult {
     ...
     */
    private fun translateActionToMove(action: PlayerAction): MoveCommand? {
     ...
     * Apply client-side prediction
     */
    private fun applyPrediction(moveCommand: MoveCommand, clientState: ClientState): MoveCommand {
