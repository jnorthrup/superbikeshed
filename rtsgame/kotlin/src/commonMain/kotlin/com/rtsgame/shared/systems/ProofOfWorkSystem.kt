...
class ProofOfWorkSystem(
     ...
     */
    private fun completeBreach(breach: BreachAttempt) {
     ...
     */
    private fun applyCommandInjection(sourceId: Long, targetId: Long) {
     ...
     */
    private fun applyDataExfiltration(sourceId: Long, targetId: Long) {
     ...
     */
    private fun applyNetworkDisruption(targetId: Long) {
        val target = entityManager.getEntity(targetId)
        val networkSecurity = target?.getComponent<NetworkSecurity>()
     ...
     */
    private fun applyCoreCompromise(sourceId: Long, targetId: Long) {
     ...
     */
    private fun findBreachAttempt(breachId: Long): BreachAttempt? {
