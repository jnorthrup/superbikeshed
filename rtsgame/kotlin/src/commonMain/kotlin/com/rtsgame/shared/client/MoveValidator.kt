...
class MoveValidator(
    ...
    private val commandSystem: CommandAndControlSystem,
    private val proofOfWorkSystem: ProofOfWorkSystem,
    private val computroniumSystem: ComputroniumSystem
) {
     ...
     */
    private fun validateMoveParameters(move: MoveClient.MoveCommand): ValidationResult {
     ...
     */
    private fun validateMoveCommand(move: MoveClient.MoveCommand): ValidationResult {
     ...
     */
    private fun validateAttackCommand(move: MoveClient.MoveCommand): ValidationResult {
        val sourceEntity = entityManager.getEntity(move.sourceId) ?: return ValidationResult(
            isValid = false,
            errorMessage = "Source entity not found"
        )
     ...
     */
    private fun validateDefendCommand(move: MoveClient.MoveCommand): ValidationResult {
     ...
     */
    private fun validateFormationCommand(move: MoveClient.MoveCommand): ValidationResult {
     ...
     */
    private fun validateResourceCommand(move: MoveClient.MoveCommand): ValidationResult {
        val sourceEntity = entityManager.getEntity(move.sourceId) ?: return ValidationResult(
            isValid = false,
            errorMessage = "Source entity not found"
        )
     ...
     */
    private fun validateAbilityCommand(move: MoveClient.MoveCommand): ValidationResult {
        val sourceEntity = entityManager.getEntity(move.sourceId) ?: return ValidationResult(
            isValid = false,
            errorMessage = "Source entity not found"
        )
