...
exports.battleJournal = exports.BattleJournal = void 0;
...
class BattleJournal {
    ...
    startRecording(battleConfig = {}) {
        ...
        const battleSeed = (0, deterministicRNG_js_1.createReproducibleSeed)(battleId, Date.now());
        // Enable deterministic mode for reproducible battles
        (0, deterministicRNG_js_1.enableDeterministicMode)(battleSeed);
        this.currentBattle = {
            id: battleId,
            startTime: Date.now(),
            config: Object.assign({ battleSeed: battleSeed, terrainSeed: deterministicRNG_js_1.gameRNG.randomInt(1, 1000000), startingResources: { mass: 100, energy: 150 }, gameMode: 'standard', deterministic: true }, battleConfig),
            metadata: {
    ...
    recordFrame(gameContext) {
        if (!this.isRecording || !this.currentBattle)
            return;
        this.frameCount++;
        ...
        return {
            ...
            units: units.map(unit => {
                ...
                return ({
                    ...
                    maxHp: unit.maxHp,
                    target: unit.target ? {
                        type: ((_a = unit.target.type) === null || _a === void 0 ? void 0 : _a.name) || 'building',
            ...
            buildings: buildings.map(building => {
                ...
                return ({
                    ...
                    productionQueue: ((_a = building.productionQueue) === null || _a === void 0 ? void 0 : _a.length) || 0
                });
            }),
            resources: {
                blue: Object.assign({}, resources.blue),
                red: Object.assign({}, resources.red)
            },
            camera: {
    ...
    determineGamePhase(gameContext) {
        ...
        if (time < 60 || totalBuildings < 2)
            return 'early';
        if (time < 180 || totalBuildings < 6 || totalUnits < 8)
            return 'mid';
        return 'late';
    }
    ...
    recordInputCommand(commandType, commandData, playerId = 'human') {
        ...
        const command = {
            ...
            playerId,
            commandType,
            commandData: Object.assign({}, commandData),
            rngCallCount: deterministicRNG_js_1.gameRNG.callCount,
            timestamp: Date.now()
        };
    ...
    recordRNGState() {
        ...
        this.currentBattle.rngState.push({
            time: this.currentBattle.stateSnapshots.length > 0 ?
                this.currentBattle.stateSnapshots[this.currentBattle.stateSnapshots.length - 1].time : 0,
            frame: this.frameCount,
            state: deterministicRNG_js_1.gameRNG.getState(),
            timestamp: Date.now()
        });
    }
...
exports.BattleJournal = BattleJournal;
// Export singleton instance
exports.battleJournal = new BattleJournal();
