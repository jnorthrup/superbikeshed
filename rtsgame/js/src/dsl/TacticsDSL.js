...
exports.CommandChain = exports.APMComposer = exports.BlockLayout = exports.CommandBlocks = exports.TacticsExpression = void 0;
exports.createExamplePrograms = createExamplePrograms;
// Core DSL Grammar Classes
class TacticsExpression {
...
exports.TacticsExpression = TacticsExpression;
...
exports.CommandBlocks = CommandBlocks;
...
class BlockLayout {
    ...
    renderBlock(expression, x, y) {
        ...
        return {
            ...
            children: expression.children.map((child, i) => this.renderBlock(child, x + 20, y + 60 + (i * 50)))
        };
    }
...
class APMComposer {
    ...
    createVisualProgram() {
        return {
            ...
            generateCode: () => {
                return this.layout.workspace.map(block => this.blockToExpression(block));
            },
    ...
    executeExpression(expr, gameState) { }
    blockToExpression(block) { return new TacticsExpression(block.type); }
}
exports.APMComposer = APMComposer;
...
function createExamplePrograms() {
