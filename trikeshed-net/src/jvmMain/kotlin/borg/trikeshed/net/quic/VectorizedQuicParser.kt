...
class VectorizedQuicParser {
    ...
    private val LONG_SPECIES = LongVector.SPECIES_PREFERRED
     ...
     */
    private fun parseSameSizeBatch(packets: List<ByteArray>): List<QuicHeader?> {
        val results = mutableListOf<QuicHeader?>()
     ...
     */
    private fun classifyPacketsVectorized(firstBytes: ByteArray): Array<PacketClass> {
    ...
    private fun parseLongHeaderVectorized(
    ...
    private fun parseShortHeaderVectorized(
        segment: MemorySegment,
        offset: Long,
        size: Int
    ): QuicShortHeader? {
