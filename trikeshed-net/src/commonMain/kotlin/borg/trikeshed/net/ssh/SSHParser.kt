...
private fun ByteIndexedBuffer.readUInt32(): UInt? {
...
private fun ByteIndexedBuffer.readByte(): Byte? {
    if (this.rem < 1) return null
    return this.get()
}

// Extension function to read a specified number of bytes from a ByteIndexedBuffer
private fun ByteIndexedBuffer.readBytes(count: Int): Indexed<Byte>? {
