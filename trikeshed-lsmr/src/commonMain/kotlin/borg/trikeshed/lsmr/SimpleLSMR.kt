...
class SimpleLSMR {
    ...
    internal val deviceData = mutableListOf<Pair<HierarchicalKey, MetricReading>>()
    internal val facilityAggregates = mutableMapOf<String, AggregateStats>()
    internal val regionAggregates = mutableMapOf<String, AggregateStats>()
    ...
    internal fun updateFacilityAggregate(facility: String) {
    ...
    internal fun updateRegionAggregate(region: String) {
    ...
    internal fun computeStats(readings: List<MetricReading>): AggregateStats {
        if (readings.isEmpty()) {
