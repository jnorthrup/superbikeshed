...
enum class Http3ErrorCode(val value: ULong) {
    ...
    companion object {
        fun fromValue(value: ULong): Http3ErrorCode? = values().find { it.value == value }
    }
}
...
enum class Http3FrameType(val value: ULong) {
    ...
    companion object {
        fun fromValue(value: ULong): Http3FrameType? = values().find { it.value == value }
    }
}
...
enum class Http3Setting(val id: ULong) {
    ...
    companion object {
        fun fromId(id: ULong): Http3Setting? = values().find { it.id == id }
    }
}
...
enum class Http3StreamType(val value: ULong) {
    ...
    companion object {
        fun fromValue(value: ULong): Http3StreamType? = values().find { it.value == value }
    }
}