...
actual class StraceAttention {
    ...
    internal val syscallMap = mutableMapOf<String, Int>()
    internal val eventBuffer = mutableListOf<SyscallEvent>()
    ...
    internal fun parseStraceOutput(output: String): List<SyscallEvent> {
...
internal fun List<String>.toCStringArray(): Array<CPointer<ByteVar>> {
