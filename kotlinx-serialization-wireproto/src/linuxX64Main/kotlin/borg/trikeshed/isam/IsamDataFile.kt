...
actual class IsamDataFile actual constructor(
    ...
    internal lateinit var data: COpaquePointer
    var fileSize: Long = -1
...
class AsyncIOConfigDSL {
    internal var useUring: Boolean = true
    internal var useScatterGather: Boolean = false
    internal var useUnbuffered: Boolean = true
    internal var batchSize: Int = 32
    internal var queueDepth: Int = 64
    internal var useMmap: Boolean = true
    internal var useKqueue: Boolean = false
    internal var useEpoll: Boolean = false
    internal var bufferSize: Int = 4096
    internal var alignment: Int = 512
 ...
 */
class AsyncIOWriter(internal val config: AsyncIOConfig) {
    ...
    internal fun writeWithUring(cursor: Cursor, datafilename: String, meta: Indexed<RecordMeta>) {
    ...
    internal fun writeWithKqueue(cursor: Cursor, datafilename: String, meta: Indexed<RecordMeta>) {
        // kqueue implementation for POSIX systems
        TODO("Implement kqueue-based async I/O")
    }

    internal fun writeWithEpoll(cursor: Cursor, datafilename: String, meta: Indexed<RecordMeta>) {
        // epoll implementation for Linux
        TODO("Implement epoll-based async I/O")
    }

    internal fun writeWithMmap(cursor: Cursor, datafilename: String, meta: Indexed<RecordMeta>) {
        // mmap-based implementation
        TODO("Implement mmap-based I/O")
    }

    internal fun writeWithBuffered(cursor: Cursor, datafilename: String, meta: Indexed<RecordMeta>) {
        // Buffered I/O implementation
        TODO("Implement buffered I/O")
    }

    internal fun appendWithUring(
        msf: Iterable<RowVec>,
        datafilename: String,
        varChars: Map<String, Int>,
        transform: ((RowVec) -> RowVec)?
    ...
    internal fun appendWithBuffered(
        msf: Iterable<RowVec>,
        datafilename: String,
        varChars: Map<String, Int>,
        transform: ((RowVec) -> RowVec)?
