...
class EnumFlotillaProcessor(
    ...
    internal fun collectAnnotatedClasses(resolver: Resolver, annotationSuffix: String): List<KSClassDeclaration> {
    ...
    internal fun generateHandlerFlotilla(handlers: List<KSClassDeclaration>) {
    ...
    internal fun generateServiceFlotilla(services: List<KSClassDeclaration>) {
    ...
    internal fun generatePluginFlotilla(plugins: List<KSClassDeclaration>) {
    ...
    internal fun generateWorkflowFlotilla(workflows: List<KSClassDeclaration>) {
    ...
    internal fun generateCapabilityFlotilla(capabilities: List<KSClassDeclaration>) {
    ...
    internal fun generateMasterRegistry(
        handlerCount: Int,
        serviceCount: Int,
        pluginCount: Int,
        workflowCount: Int,
    ...
    internal fun generateProcessorPathway() {
        val pathwayMermaid = """
    ...
    internal fun writeGeneratedFile(name: String, content: String) {
    ...
    internal fun extractCapabilities(classDecl: KSClassDeclaration): List<String> {
    ...
    internal fun extractDescription(classDecl: KSClassDeclaration): String {
        val handlerAnnotation = classDecl.annotations.find { 
            it.shortName.asString() == "Handler" 
        }
    ...
    internal fun extractDependencies(classDecl: KSClassDeclaration): List<String> {
    ...
    internal fun extractVersion(classDecl: KSClassDeclaration): String {
    ...
    internal fun extractPluginName(classDecl: KSClassDeclaration): String {
    ...
    internal fun extractEnabled(classDecl: KSClassDeclaration): Boolean {
        val pluginAnnotation = classDecl.annotations.find { 
            it.shortName.asString() == "Plugin" 
        }
    ...
    internal fun extractTriggers(classDecl: KSClassDeclaration): List<String> {
    ...
    internal fun extractPriority(classDecl: KSClassDeclaration): Int {
        val workflowAnnotation = classDecl.annotations.find { 
            it.shortName.asString() == "Workflow" 
        }
    ...
    internal fun extractCategory(classDecl: KSClassDeclaration): String {
    ...
    internal fun extractRequired(classDecl: KSClassDeclaration): Boolean {
        val capabilityAnnotation = classDecl.annotations.find { 
            it.shortName.asString() == "Capability" 
        }
