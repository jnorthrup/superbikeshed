...
class IntelliJProjectParser {
    ...
    private val mavenParser = MavenPomParser()
    private val gradleParser = GradleBuildParser()
    ...
    private fun locateAndParseBuildSystem(
        directory: Path,
        projectRoot: Path,
    ...
    private fun resolvePath(pathStr: String?, projectRoot: Path, moduleDir: Path? = null): String? {
    ...
    private fun parseOrderEntry(element: StartElement, dependencies: MutableList<DependencyInfo>, sdkInfoConsumer: (String?, Boolean) -> Unit) {
