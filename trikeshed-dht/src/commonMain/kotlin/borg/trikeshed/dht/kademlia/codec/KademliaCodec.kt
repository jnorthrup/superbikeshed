...
object BinaryPacker {
    ...
    internal fun packField(buffer: MutableList<Byte>, key: String, value: Any?) {
        // Pack field name
    ...
    internal fun packLong(buffer: MutableList<Byte>, value: Long) {
        for (i in 7 downTo 0) {
            buffer.add(((value shr (i * 8)) and 0xFF).toByte())
        }
    }
    
    internal fun packInt(buffer: MutableList<Byte>, value: Int) {
        for (i in 3 downTo 0) {
            buffer.add(((value shr (i * 8)) and 0xFF).toByte())
        }
    }
...
object BinaryUnpacker {
    ...
    internal fun unpackField(data: Indexed<Byte>, offset: Int): Triple<String, Any?, Int> {
        var pos = offset
    ...
    internal fun unpackLong(data: Indexed<Byte>, offset: Int): Long {
        var result = 0L
        for (i in 0 until 8) {
    ...
    internal fun unpackInt(data: Indexed<Byte>, offset: Int): Int {
        var result = 0
        for (i in 0 until 4) {
