...
class RoutingTable(
    ...
    internal val k: Int = 20
) {
    internal val buckets = mutableListOf<KBucket>()
    ...
    internal fun getBucketIndex(nodeId: NUID): Int {
    ...
    internal fun shouldSplitBucket(bucketIndex: Int): Boolean {
        val bucket = buckets[bucketIndex]
    ...
    internal fun splitBucket(bucketIndex: Int) {
