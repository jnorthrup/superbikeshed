...
class SimdQuicParser(
    ...
    private fun parseSimdBatch(packets: List<ByteArray>): List<QuicPacketInfo> {
    ...
    private fun decodeVintScalar(data: ByteArray, pos: Int): Long {
    ...
    private fun extractCidBatch(packets: List<ByteArray>): List<ByteArray?> {
