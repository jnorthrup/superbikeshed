...
/**
 * Linux x86 SIMD implementation (SSE/AVX/AVX2)
 * Uses C interop for SSE/AVX/AVX2 intrinsics.
 */
class LinuxSimdStrategy : SimdStrategy {
 ...
 */
actual fun createSimdStrategy(): SimdStrategy = LinuxSimdStrategy() 