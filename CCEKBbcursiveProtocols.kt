...
object SimpleLineProtocol {
    ...
    class LineProtocolChoreographer {
        ...
        private fun parseMessage(buf: ByteIndexedBuffer): Message? {
        ...
        private fun validateConstraint(msg: Message, constraint: Constraint): Boolean {
        ...
        private fun captureUntilCrlf(buf: ByteIndexedBuffer): String? {
            val start = buf.pos
            while (buf.hasRemaining && buf.peek != '\r'.code.toByte()) buf.inc()
...
object SimpleHttpProtocol {
    ...
    class HttpProtocolHandler {
        ...
        private fun parseRequest(buf: ByteIndexedBuffer): Request? {
        ...
        private fun validateRequest(req: Request?, knowledge: Knowledge): Request? {
            req ?: return null
        ...
        private fun transformRequest(req: Request?, knowledge: Knowledge): Any? {
            req ?: return null
        ...
        private fun captureToken(buf: ByteIndexedBuffer): String? {
            val start = buf.pos
        ...
        private fun capturePath(buf: ByteIndexedBuffer): String? {
            val start = buf.pos
...
class ByteIndexedBuffer(input: String) {
    ...
    private val data = input.encodeToByteArray()
    var pos = 0
