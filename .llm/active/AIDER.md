# GoalStrikeshed Architectural Momentum System v2.0 - Aider Edition
...
## Aider File Priority Override System

### File Reading Priority (Highest to Lowest)
1. **`.aider.md`** - Primary configuration (THIS FILE)
...
- **Commit Readiness**: +12 points for ensuring changes are ready for commit
...
- **Iterative Refinement**: +18 points for multiple review cycles
- **Simplicity Evolution**: +20 points for evolving toward simpler solutions
- **Git Awareness**: +15 points for understanding git implications
- **Review Depth**: +16 points for comprehensive review processes
- **Commit Preparation**: +12 points for preparing clean, atomic commits
- **Workflow Efficiency**: +14 points for streamlined CLI workflows
...
### Multiple Turn Review Process
- **Iterative Refinement**: Review and refine code across multiple turns
- **Feedback Integration**: Incorporate feedback from each review cycle
- **Quality Assurance**: Ensure high quality before final commitment
- **Pattern Recognition**: Identify and apply patterns from previous reviews
- **Evolution Tracking**: Track how solutions evolve toward simplicity

### Simple Solution Evolution
- **+1 Simple Solutions**: Evolve toward solutions that are just one step better
- **Complexity Reduction**: Simplify complex solutions through iteration
- **Minimal Changes**: Make the smallest effective changes
- **Incremental Improvement**: Build solutions through small, focused improvements
- **Elegance Pursuit**: Pursue elegant, simple solutions

### CLI Workflow
- **File Operations**: Use Aider's file editing commands for precise code changes
- **Git Integration**: Leverage Aider's git-aware capabilities for version control
- **Incremental Development**: Make focused, atomic changes that can be easily reviewed
- **Command Line Efficiency**: Use concise, effective commands for file operations

### Code Generation Style
- **CLI-Friendly Code**: Generate code that works well in command-line environments
- **Script Integration**: Consider how code will be used in build scripts and automation
- **Error Handling**: Include robust error handling for CLI operations
- **Review-Ready**: Write code that's ready for review and iteration
...
8. **Iterative Refinement (`N++`):** Extend the chain through multiple review cycles.
9. **Simplicity Evolution (`N++`):** Extend the chain by evolving toward simpler solutions.
10. **Lambda Type Mastery (`N++`):** Extend the chain by creating perfect infix lambda type annotations on the first try.
...
- **Premature Commitment:** Committing changes without proper review and iteration.
- **Complexity Accumulation:** Adding unnecessary complexity instead of evolving toward simplicity.
...
9. **Axiom of Iterative Refinement:** Solutions improve through multiple review cycles.
10. **Axiom of Simplicity Evolution:** Solutions evolve toward +1 simple improvements.
11. **Axiom of Lambda Type Mastery:** Infix lambda expressions must have perfect type annotations.
...
- **Iterative Patterns**: Patterns that improve through multiple review cycles
- **Simplicity Patterns**: Patterns that evolve toward simpler solutions
...
- Use Aider's file editing capabilities for precise changes
- Consider git implications when making changes
- Leverage command-line tools for efficient development
